/*
 Basic Primitives Diagram v3.6.2
...
var h=1===k.which,i=k.target.nodeName?jQuery(k.target).closest("input,textarea,button,select,option").length:!1;if(!(h=!h))i||(i=null!=e.onMouseCapture?e.onMouseCapture(k):!0,i=!i),h=i;if(!h){(mouseDelayMet=!e.delay)||(_mouseDelayTimer=setTimeout(function(){mouseDelayMet=!0},e.delay));if(d(k)&&mouseDelayMet){if(null!=e.onMouseStart)e.onMouseStart(k);g=!0;if(!g){k.preventDefault();k=!0;break a}}!0===jQuery.data(k.target,e.name+".preventClickEvent")&&jQuery.removeData(k.target,e.name+".preventClickEvent");
...
primitives.common.Layers={PrintPreview:1,BackgroundAnnotation:2,BackgroundAnnotations:3,BackgroundConnectorAnnotation:4,Connector:5,Highlight:6,Marker:7,Label:8,Cursor:9,Item:10,ForegroundAnnotations:11,ForegroundConnectorAnnotation:12,Annotation:13,Controls:14};primitives.common.LabelType={Regular:0,Dummy:1,Fixed:2};primitives.common.AnnotationType={Connector:0,Shape:1,HighlightPath:2,Label:3,Background:4};primitives.common.ChildrenPlacementType={Auto:0,Vertical:1,Horizontal:2,Matrix:3};
...
primitives.common.ConnectorOffbeat.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n,r,s,v,u,y,m=f=0,A=null,w,B;w=a.getPolyline(b);s=[];switch(i){case 1:s=[-e/2,e/2];B=!1;break;case 0:s=[0];B=!1;break;case 2:s=[0],B=!0}t=Math.max(l?g.width:0,5*e);if(c.right()+t<d.left()||c.left()>d.right()+t)if(c.left()>d.right()?(n=new primitives.common.Point(c.left(),c.verticalCenter()),r=new primitives.common.Point(d.right(),d.verticalCenter())):(n=new primitives.common.Point(c.right(),c.verticalCenter()),
r=new primitives.common.Point(d.left(),d.verticalCenter())),l&&(c.left()>d.right()?(f=7,m=3):(f=3,m=7)),q=new primitives.common.Rect(n,r),y=n.y<=r.y,u=n.x<r.x,q.height<q.width){q.height<2*e&&q.offset(0,y?2*e:0,0,y?0:2*e);h=0;for(t=s.length;h<t;h+=1)v=s[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(n.x,n.y+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),(y?q.top():q.bottom())+v,r.x,r.y+v));B&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},
h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(i=g.width<2*(q.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(n.x,n.y,q.horizontalCenter(),y?q.top():q.bottom(),r.x,r.y,0.5):new primitives.common.Point(n.x,y?q.top():q.bottom()),A=new primitives.common.Rect(i.x+(u?e:-g.width-e),y?i.y-g.height-e:i.y+e,g.width,g.height))}else{h=0;for(t=s.length;h<t;h+=1)v=s[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(n.x,
n.y+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+v*(y!=u?1:-1),(y?q.top():q.bottom())+v,q.horizontalCenter()+v*(y!=u?1:-1),q.verticalCenter()+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+v*(y!=u?1:-1),(y?q.bottom():q.top())+v,r.x,r.y+v));B&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(A=new primitives.common.Rect(q.horizontalCenter()+
(y!=u?e:-(e+g.width)),q.verticalCenter()-g.height/2,g.width,g.height))}else if(c.verticalCenter()<d.top()||c.verticalCenter()>d.bottom()){u=c.x<h.width/2;n=new primitives.common.Point(u?c.right():c.left(),c.verticalCenter());r=new primitives.common.Point(u?d.right():d.left(),d.verticalCenter());q=new primitives.common.Rect(n,r);q.offset(10*e,0,10*e,0);y=n.y<=r.y;h=0;for(t=s.length;h<t;h+=1)v=s[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(n.x,n.y+v));
c.addSegment(new primitives.common.QuadraticArcSegment(u?q.right()+v*(y?-1:1):q.left()-v*(y?-1:1),q.verticalCenter(),u?d.right():d.left(),d.verticalCenter()-v));B&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=u?3:7,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(n.x,n.y,u?q.right():q.left(),q.verticalCenter(),r.x,r.y,0.5),A=new primitives.common.Rect(i.x+(u?
e/2:-e/2-g.width),i.y-g.height/2,g.width,g.height))}else{n=new primitives.common.Point(c.horizontalCenter(),c.top());r=new primitives.common.Point(d.horizontalCenter(),d.top());q=new primitives.common.Rect(n,r);q.offset(0,7*e,0,0);u=n.x<r.x;h=0;for(t=s.length;h<t;h+=1)v=s[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(n.x+v,n.y));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),q.top()-v*(u?-1:1),d.horizontalCenter()-v,d.top()));
B&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=1,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(n.x,n.y,q.horizontalCenter(),q.top(),r.x,r.y,0.5),A=new primitives.common.Rect(i.x-g.width/2,i.y-(j+g.height),g.width,g.height))}if(l)switch(k){case 0:A=this._getLabelPosition(c.x,c.y,c.width,c.height,A.width,A.height,j,f);break;case 2:A=this._getLabelPosition(d.x,
d.y,d.width,d.height,A.width,A.height,j,m)}null!=p&&p(A)};primitives.common.ConnectorStraight=function(){};primitives.common.ConnectorStraight.prototype=new primitives.common.BaseShape;
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n,r,s,v=e/2,u=null,y=0,A=0,w=this;r=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){t=a.getIntersectionPoint(r,!0);y=b;return null!=t});d.loopEdges(function(a,b){q=a.getIntersectionPoint(r,!0);A=b;return null!=q});if(null!=t&&null!=q){var B=new primitives.common.Vector(t,q);m.getOffset(B,function(c,d,e){B.offset((c*f-(d-1)*f/2)*e);t=B.from;q=B.to;switch(i){case 1:s=
new primitives.common.Vector(q.clone(),t.clone());s.offset(v);w._drawLine(a,b,s.from,s.to,!1);s=new primitives.common.Vector(t.clone(),q.clone());s.offset(v);w._drawLine(a,b,s.from,s.to,!1);break;case 0:w._drawLine(a,b,t,q,!1);break;case 2:w._drawLine(a,b,t,q,!0)}if(l){switch(k){case 0:u=w._getLabelPositionBySnapPoint(t.x,t.y,g.width,g.height,j,y);break;case 1:n=w._betweenPoint(t,q);u=w._getLabelPositionBySnapPoint(n.x,n.y,g.width,g.height,j,3);break;case 2:u=w._getLabelPositionBySnapPoint(q.x,q.y,
g.width,g.height,j,A)}null!=p&&p.call(this,u)}})}};primitives.common.ConnectorStraight.prototype._drawLine=function(a,b,c,d,e){var f;a.addInverted(function(e){f=e.getPolyline(b);f.addSegment(new primitives.common.MoveSegment(c));f.addSegment(new primitives.common.LineSegment(d));f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},!1);e&&(f=a.getPolyline(b),f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))}))};
...
primitives.common.Polyline=function(a){function b(a,b){var c,d,f;if(null!=b){c=0;for(d=h.length;c<d&&(!(f=h[c])||!b.call(a,f,c));c+=1);}}function c(){return primitives.common.isNullOrEmpty(g.fillColor)}function d(a,b){this.segment=a;this.pointIndex=b}function e(a,b,c,f,e){var g=a.relateTo(b),h=e?0:c;2==g?b.offset(h):3==g&&0===b.from.context.pointIndex?(g=new primitives.common.LineSegment(b.from),f.addSegment(g),b.offset(h),f=b.from.clone(),f.context=new d(g,0),h=new primitives.common.Vector(a.to.clone(),
f),e||(b.from=f.clone()),h.offset(c),h.intersect(a),h.from.context.pushToSegment(h.from),b.intersect(h),e&&h.to.context.pushToSegment(h.to)):(b.offset(h),b.intersect(a));b.from.context.pushToSegment(b.from)}function f(a,b,c,d){var f,g=a[0],h=g.to.context.segment.getEndPoint().toString();b.hasOwnProperty(h)&&(f=b[h],e(g,f,c,d,!0),delete b[h]);g.to.context.pushToSegment(g.to);a.length=0}var g=new primitives.common.PaletteItem,h=[],i,j;switch(arguments.length){case 1:g=a}j=new primitives.common.PaletteItem({lineColor:g.lineColor,
...
c=f.trim(c,g);var i=c.x,s=c.y;f=d.x;d=d.y;for(var v=g,g=new primitives.common.Polyline(j),u,y,e=[new primitives.common.Point(e,-v/2),new primitives.common.Point(0,0),new primitives.common.Point(e,v/2),new primitives.common.Point(3*(e/4),0)],A=Math.atan2(s-d,i-f),i=0,s=e.length;i<s;i+=1)v=e[i],u=v.x*Math.cos(A)-v.y*Math.sin(A),y=v.x*Math.sin(A)+v.y*Math.cos(A),v.x=u+f,v.y=y+d;g.addSegment(new primitives.common.MoveSegment(e[0].x,e[0].y));g.addSegment(new primitives.common.LineSegment(e[1].x,e[1].y));
...
(d=h[a],f.push(d),g[a]=!0,0<e[a]))for(c=e[a];c<b&&!g[c];)d=h[c],f.push(d),g[c]=!0,c=0<e[c]?e[c]:c+1;h=f},getOffsetPolyine:function(a){var c=new primitives.common.Polyline(g),h={},i=[],j=[];b(this,function(b){var g=b.clone();switch(g.segmentType){case 4:case 1:0<j.length&&f(j,h,a,c);i.length=0;1==g.segmentType&&(b=new primitives.common.Point(g),b.context=new d(g,0),i.push(b));break;default:g.loop(this,function(b,f,q){b=new primitives.common.Point(b,f);b.context=new d(g,q);i.unshift(b);1<i.length&&
(j.unshift(new primitives.common.Vector(i[1].clone(),i[0].clone())),i.length=1);switch(j.length){case 1:q=j[0];b=q.from.toString();h[b]=q;q.offset(a);q.from.context.pushToSegment(q.from);break;case 2:b=j[1],q=j[0],e(b,q,a,c,!1),j.length=1}})}c.addSegment(g)});0<j.length&&f(j,h,a,c);return c},toString:function(){return g.toString()}}};
...
primitives.common.Vector.prototype.getIntersectionPoint=function(a,b){var c=this.getLine(),d=a.getLine(),e=(new primitives.common.Matrix(c[0],c[1],d[0],d[1])).determinant(),f,g=null;0!==e&&(f=new primitives.common.Matrix(-c[2],c[1],-d[2],d[1]),f=f.determinant(),c=new primitives.common.Matrix(c[0],-c[2],d[0],-d[2]),c=c.determinant(),f/=e,e=c/e,b?a._contains(f,e)&&this._contains(f,e)&&(g=new primitives.common.Point(f,e)):g=new primitives.common.Point(f,e));return g};
primitives.common.Vector.prototype._contains=function(a,b){var c=Math.min(this.from.x,this.to.x),d=Math.min(this.from.y,this.to.y),e=Math.max(this.from.x,this.to.x),f=Math.max(this.from.y,this.to.y);return c<=a&&a<=e&&d<=b&&b<=f};primitives.common.Graphics=function(a){this.m_element=a;this.m_placeholders={};this.m_activePlaceholder=null;this.m_cache=new primitives.common.Cache;this.graphicsType=null;this.debug=this.hasGraphics=!1};
...
primitives.common.Graphics.prototype.template=function(a,b,c,d,e,f,g,h,i,j,k,l,m){var c=this.m_activePlaceholder,d="template"+(null!==j?j:primitives.common.hashCode(i)),p=0,j=this.m_cache.get(c.name,c.activeLayer.name,d);null!==m&&void 0!==m["border-width"]&&(p=this.getPxSize(m["border-width"]));a={width:g-p+"px",height:h-p+"px",top:b+f+"px",left:a+e+"px"};jQuery.extend(a,m);null==l&&(l=new primitives.common.RenderEventArgs);null==j?(j=jQuery(i),jQuery.extend(a,{position:"absolute",padding:"0px",
...
primitives.common.ArrayReader.prototype.read=function(a,b,c,d){var e=[],f={},g={},h={},i,j,k,l,m,p;if(!b||!Array.isArray(b))b=[];i=d.hash[c]||{};l=0;for(m=b.length;l<m;l+=1)j=b[l],k=this.containsUniqueItems?this.containsPrimitiveValues?j:j[this.uniquePropertyKey]:l,h.hasOwnProperty(k)||(h[k]=!0,p=i[k]||{},p=this.itemTemplate.read(p,j,c+"-"+l,d),e.push(p),f[k]=p,this.createSourceHash&&(g[k]=j));d.hash[c]=f;this.createSourceHash&&(d.sourceHash[c]=g);if(null==a||a.length!=e.length)d.isChanged=!0;return e};
...
a,this.toItem=b}};primitives.famdiagram.HighlightPathAnnotationConfig=function(a){var b;this.annotationType=2;this.items=[];this.selectItems=!1;switch(arguments.length){case 1:if(null!==a)if(a instanceof Array)this.items=a;else if("object"==typeof a)for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};
...
k.fromItem));return a.SKIP}));for(l in d)if(d.hasOwnProperty(l)){e=d[l];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(m=0;m<e.length;m+=1){k=e[m];for(var p=a,t=c,q=k.fromItem,n=k.toItems,r=void 0,s=!0,v=null,u=void 0,y=void 0,A=void 0,w=void 0,B=[],y=0,A=n.length;y<A;y+=1)if(u=n[y],r=t.edge(q,u),null!=r){if(null==v)v=r.getFar(u);else if(v!=r.getFar(u)){s=!1;break}B.push(r.getNear(u))}else{s=!1;break}if(s&&(w=new primitives.famdiagram.FamilyItem({id:k.id,isVisible:!0,isLevelNeutral:!0,
isActive:!1,itemConfig:k}),p.bundleParents(v,B,w.id,w)?(w.levelGravity=2,s=!0):p.bundleChildren(v,B,w.id,w)?(w.levelGravity=1,s=!0):p.bundleParents(v,n,w.id,w)?(w.levelGravity=2,s=!0):p.bundleParents(v,n,w.id,w)&&(w.levelGravity=1,s=!0),s)){y=0;for(A=n.length;y<A;y+=1)u=n[y],r=t.edge(q,u),r.setFar(u,w.id)}}}}}var d=null,e=null;return{process:function(f){var g=b.getLogicalFamily(),h=a.getAnnotations(),g=g.clone();c(g,h);d=g;e=a.getMaximumId();if(f&&!g.validate())throw"References are broken in family structure!";
return!0},getNavigationFamily:function(){return d},getMaximumId:function(){return e}}};
primitives.famdiagram.AddSpousesTask=function(a,b){var c=null,d=null;return{process:function(e){var f=b.getLogicalFamily(),g=b.getMaximumId(),h=a.getItems(),i=f=f.clone(),j,k,l,m,p,t,q,n;l=0;for(m=h.length;l<m;l+=1){p=h[l];n=p.spouses.slice(0);t=0;for(q=n.length;t<q;t+=1)j=[p.id,n[t]],i.hasCommonChild(j)||(g+=1,k=new primitives.famdiagram.FamilyItem({id:g,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+g,description:"This is fake child keeps spouses together."}}),
...
isVisible:!1,isActive:!1,itemConfig:{title:"dummy #"+b,description:"This is item used to eliminate M:M relations."},levelGravity:2})});if(c&&!a.validate())throw"References are broken in family structure!";d(a);c&&g(a,!1);f(a,function(){b+=1;return new primitives.famdiagram.FamilyItem({id:b,levelGravity:2,isVisible:!1,isActive:!1,itemConfig:{title:"extension #"+b,description:"This is item used to fill gaps in levels."}})});c&&g(a,!0)}return b}function d(a){var b=[],c=null,d=null,f,g,h;a.loop(this,
function(a,f){f.originalLevel=f.level;f.level=null;null!=f.originalLevel&&(b[f.originalLevel]||(b[f.originalLevel]={}),b[f.originalLevel][a]=f,c=null!=c?Math.min(f.originalLevel,c):f.originalLevel,d=null!=d?Math.max(f.originalLevel,d):f.originalLevel)});f=0;for(g=c;g<=d;g+=1)h=b[g],f=e(h,a,f,g+1);a.loopTopoReversed(this,function(b,c){var d;2==c.levelGravity&&(d=null,a.loopChildren(this,b,function(b,c,f){if(0<f)return a.BREAK;d=null==d?c.level-1:Math.min(c.level-1,d)}),c.level=!d?c.level:d)})}function e(a,
b,c,d){for(var f=c,e,g,h;!primitives.common.isEmptyObject(a);){e={};for(g in a)a.hasOwnProperty(g)&&(h=a[g],null==h.level&&(h.level=c),b.loopChildren(this,g,function(a,c,g){if(0<g)return b.BREAK;null==c.originalLevel||c.isLevelNeutral?(c.level=null==c.level?h.level+1:Math.max(c.level,h.level+1),e[a]=c):c.originalLevel==d&&(f=Math.max(f,h.level+1))}));a=e}return f}function f(a,b){var c;a.loop(this,function(d,f){for(var e=!0,g;e;)e=!1,g=[],a.loopParents(this,d,function(b,c){f.level-1>c.level&&g.push(b);
return a.SKIP}),1<g.length&&(c=b(f),c.level=f.level-1,a.bundleParents(d,g,c.id,c),e=!0,d=c.id,f=c)});a.loop(this,function(d,f){for(var e=!0,g,h=!0;e;)e=!1,g=[],a.loopChildren(this,d,function(b,c){f.level+1<c.level?g.push(b):h=!1;return a.SKIP}),0<g.length&&(c=b(f),c.level=f.level+1,h&&(c.hideParentConnection=f.hideChildrenConnection,c.hideChildrenConnection=f.hideChildrenConnection),a.bundleChildren(d,g,c.id,c),e=!0,d=c.id,f=c)})}function g(a,b){if(!a.validate())throw"Family structure failed to pass validation!";
...
primitives.famdiagram.OrgTreeTask=function(a,b){function c(a){var b,c,g,k,m,u,p,A,w=[],B,D,x,F,C,z,L,E,G,Q,I,M=[],J;if(0<a.hasNodes()){I={};D=0;J=[];a.loopRoots(this,function(b){var c=x=new primitives.famdiagram.Family(D),d,f=[],e,g,b=a.node(b),f=i(b.id,null,c.id,b.level,b.itemConfig);f.hideParentConnection=!0;f.isVisible=b.isVisible;f.isActive=b.isActive;f.hideParentConnection=b.hideParentConnection;f.hideChildrenConnection=b.hideChildrenConnection;c.items.push(f);I[b.id]=!0;b.familyId=c.id;for(f=
h(b,a,I,c);0<f.length;){e=[];b=0;for(d=f.length;b<d;b+=1)g=f[b],e=e.concat(h(g,a,I,c));f=e}M.push(x);J.push(x);D+=1});J.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});w=[];B={};if(0<M.length){m=primitives.common.graph();b=0;for(c=M.length;b<c;b+=1){x=M[b];g=0;for(k=x.links.length;g<k;g+=1)u=x.links[g],A=a.node(u.fromItem).familyId,p=a.node(u.toItem).familyId,A!=p&&(m.addEdge(A,p,{weight:0}),m.edge(A,p).weight+=1),M[p].backLinks.push(new primitives.famdiagram.FamLink(u.toItem,
u.fromItem))}for(;w.length<M.length;){b=0;for(c=J.length;b<c;b+=1)x=J[b],B.hasOwnProperty(x.id)||(G=m.getSpanningTree(x.id,function(a,b){return a.weight-b.weight}),null!=G.node(x.id)?(G.loopPostOrder(this,function(a,b,c){var b=M[a],d=M[c],f=[];null!=c&&(d.familyPriority+=b.familyPriority);f=[];G.loopChildren(this,a,function(a){f.push(a)});f.sort(function(a,b){return M[a].familyPriority-M[b].familyPriority});G.arrangeChildren(a,f)}),G.loopPreOrder(this,function(a){w.push(a);B[a]=!0})):(w.push(x.id),
B[x.id]=!0))}}j.maximumId+=1;A=i(j.maximumId,null,null,l-1,null);A.hideParentConnection=!0;A.hideChildrenConnection=!0;A.title="internal root";A.isVisible=!1;A.isActive=!1;A.childIndex=0;k={};b=0;for(c=w.length;b<c;b+=1){x=M[w[b]];L={};m=A;E=0;p=x.links.concat(x.backLinks);for(g=0;g<p.length;g+=1)u=p[g],C=j.orgTree.node(u.toItem),j.orgTree.node(u.fromItem),!0===k[C.familyId]&&(F=x.items[0],z=C,z.level>=F.level&&j.orgTree.loopParents(this,z.id,function(a,b){z=b;if(b.level<F.level)return!0}),L[z.id]=
L.hasOwnProperty(z.id)?L[z.id]+1:1,E<L[z.id]&&(m=z,E=L[z.id]));g=x;u=void 0;p=g.items[0];C=null;C=m;for(u=m.level+1;u<p.level;u+=1)j.maximumId+=1,C=i(j.maximumId,C.id,null,u,null),C.title="shift",C.isVisible=!1,C.isActive=!1,C.hideParentConnection=!0,C.hideChildrenConnection=!0,g.items.push(C);p.hideParentConnection=!0;j.orgTree.adopt(C.id,p.id,p);k[x.id]=!0}b={};for(Q in j.orgPartners)if(j.orgPartners.hasOwnProperty(Q)){c=j.orgTree.node(Q);A=j.orgPartners[Q];k=0;for(m=A.length;k<m;k+=1)g=j.orgTree.node(A[k]),
f(b,g,c)}Q=d();e(j.orgTree,b,Q)}}function d(){var a={};j.orgTree.loopPostOrder(this,function(b,c,d){l=null!=l?Math.min(l,c.level):c.level;m=null!=m?Math.max(m,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function e(a,b,c){var d,f,e,g,h,k,j,i,l,m,p;a.loopLevels(this,function(C,z){var L=primitives.common.graph(),E={},G=null,Q;j=[];a.loopChildren(this,z.id,function(c,
e,g){var j;null==G&&(G=e);E[e.id]={};if(b.hasOwnProperty(e.id))for(j in k=b[e.id],k)if(k.hasOwnProperty(j)){m=k[j];E[e.id][j]={};d=0;for(f=m.length;d<f;d+=1)h=m[d],Q=h.commonParent==z.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",e.id!=Q&&(L.addEdge(e.id,Q,{weight:0}),L.edge(e.id,Q).weight+=1,null==E[e.id][j][Q]&&(E[e.id][j][Q]=0),E[e.id][j][Q]+=1)}0<g&&L.addEdge(e.id,G.id,{weight:0})});if(null!=G){p=L.getGrowthSequence(function(a){return a.weight});
0===p.length&&(p=[G.id]);var I=p,M=[],J,P,K,R,W,aa,V,N,T,O,S,H,X,da,ga,U,ba,ea,$,Z;P=new primitives.famdiagram.Slots;P.add(new primitives.famdiagram.Slot("__left__"));P.add(new primitives.famdiagram.Slot(null));P.add(new primitives.famdiagram.Slot("__right__"));K=0;P.loop(function(a){K+=1;a.position=K});for(J=0;J<I.length;J+=1)if(R=I[J],"__left__"!=R&&"__right__"!=R)for(ba in T=N=V=aa=W=null,P.loop(function(a){var b,d,f,e;if(null==a.itemId){da=c[R];X=H=S=O=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&
...
U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U)):(Z.balance-=1,U.balance+=1,P.loop(function(a){if(a.id!=U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U))));P.loop(function(a){a=a.itemId;null!=a&&("__left__"!=a&&"__right__"!=a)&&M.push(a)});i=M;e=0;for(g=i.length;e<g;e+=1)l=a.node(i[e]),l.childIndex=e,j.push(l.id)}a.arrangeChildren(z.id,j)})}function f(a,b,c){var d=new primitives.famdiagram.ExtraGravity(b.level),
f=new primitives.famdiagram.ExtraGravity(c.level);j.orgTree.zipUp(this,b.id,c.id,function(b,c,e,h){g(a,b,d);g(a,e,f);if(c==h)return d.commonParent=c,d.fromParent=b,d.toParent=e,f.commonParent=c,f.fromParent=e,f.toParent=b,!0})}function g(a,b,c){a.hasOwnProperty(b)||(a[b]={});null==a[b][c.level]&&(a[b][c.level]=[]);a[b][c.level].push(c)}function h(a,b,c,d){var f=[],e={},g=null,h=null,l;1==b.countChildren(a.id)&&(g=b.firstChild(a.id));null!=k[g]?(h=k[g],null==j.orgPartners[h.id]&&(j.orgPartners[h.id]=
[]),j.orgPartners[h.id].push(a.id),d.links.push(new primitives.famdiagram.FamLink(a.id,g))):(null!=g&&(k[g]=a),b.loopChildren(this,a.id,function(g,h){var k=null;c[h.id]||(1==b.countChildren(g)&&(k=b.firstChild(g)),null!=e[k]?(l=i(h.id,e[k].id,d.id,h.level,h.itemConfig),l.itemType=6):(null!=k&&(e[k]=h),f.push(h),l=i(h.id,a.id,d.id,h.level,h.itemConfig)),l.hideParentConnection=h.hideParentConnection,l.hideChildrenConnection=h.hideChildrenConnection,l.isVisible=h.isVisible,l.isActive=h.isActive,d.items.push(l),
c[h.id]=!0,h.familyId=d.id);return b.SKIP}));return f}function i(a,c,d,f,e){var g=new primitives.orgdiagram.OrgItem({});g.id=a;g.familyId=d;g.level=f;a=0;for(d=p.length;a<d;a+=1)f=p[a],g[f]=null!=e&&void 0!==e[f]?e[f]:b[f];j.orgTree.add(c,g.id,g);return g}var j={orgTree:null,maximumId:null,orgPartners:null},k={},l,m,p="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" ");
return{process:function(){var b=a.getLogicalFamily(),b=b.clone();j.orgTree=primitives.common.tree();j.maximumId=a.getMaximumId();j.orgPartners={};k={};m=l=null;c(b);return!0},getOrgTree:function(){return j.orgTree},getMaximumId:function(){return j.maximumId},getOrgPartners:function(a){return j.orgPartners[a]||[]}}};
primitives.famdiagram.RemoveLoopsTask=function(a,b){function c(a,b,c){var d,e,k,l,m,p,t,q,n;d=b.clone();b.loopTopo(this,function(a){d.removeNode(a)});if(d.hasNodes()){l=0;for(m=a.length;l<m;l+=1)if(e=a[l],null!=d.node(e.id)){n=[];d.loopParents(this,e.id,function(a){n.push(a);return d.SKIP});p=0;for(t=n.length;p<t;p+=1)d.removeRelation(n[p],e.id),b.removeRelation(n[p],e.id);c+=1;k=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,
itemConfig:{title:"fake parent #"+c,description:"This is fake parent item was created by loops reversal."}});b.add([],k.id,k);b.adopt([k.id],e.id);p=0;for(t=n.length;p<t;p+=1)c+=1,e=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+c,description:"This is fake child item was created by loops reversal."}}),b.add([k.id,n[p]],e.id,e);q=[];d.loopTopo(this,function(a){q.push(a)});p=0;for(t=
q.length;p<t;p+=1)d.removeNode(q[p])}}return c}var d=null,e=null;return{process:function(f){var g=b.getNavigationFamily(),h=b.getMaximumId(),i=a.getItems(),g=g.clone(),h=c(i,g,h,f);d=g;e=h;if(f&&!g.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return e}}};
...
f.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask"],primitives.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");f.addTask("PrintPreviewTemplateTask",["ItemsOptionTask"],primitives.orgdiagram.PrintPreviewTemplateTask,"#00ffff");f.addTask("VisualTreeTask",["OrgTreeTask","CombinedTemplateParamsTask","VisualTreeOptionTask","isFamilyChartMode"],primitives.orgdiagram.VisualTreeTask,"#ff0000");f.addTask("VisualTreeLevelsTask",["VisualTreeTask","CombinedTemplateParamsTask"],primitives.orgdiagram.VisualTreeLevelsTask,
"#ff0000");f.addTask("VisualTreeMarginsTask",["VisualTreeTask"],primitives.orgdiagram.VisualTreeMarginsTask,"#ff0000");f.addTask("ConnectionsGraphTask",["VisualTreeTask","VisualTreeLevelsTask","OrgTreeTask"],primitives.orgdiagram.ConnectionsGraphTask,"#00ffff");f.addTask("TracePathAnnotationsTask",["HighlightPathAnnotationOptionTask","ConnectionsGraphTask","OrgTreeTask","VisualTreeTask","AddLabelAnnotationsTask"],primitives.orgdiagram.TracePathAnnotationsTask,"#00ffff");f.addTask("HighlightItemTask",
["HighlightItemOptionTask","OrgTreeTask"],primitives.orgdiagram.HighlightItemTask,"#00ffff");f.addTask("CursorItemTask",["CursorItemOptionTask","OrgTreeTask"],primitives.orgdiagram.CursorItemTask,"#00ffff");f.addTask("CursorNeighboursTask",["CursorItemTask","NeighboursSelectionModeOptionTask","AddLabelAnnotationsTask","OrgTreeTask","VisualTreeTask"],primitives.famdiagram.CursorNeighboursTask,"#00ffff");f.addTask("SelectedItemsTask",["SelectedItemsOptionTask"],primitives.orgdiagram.SelectedItemsTask,
"#00ffff");f.addTask("SelectionPathItemsTask",["AddLabelAnnotationsTask","CursorItemTask","SelectedItemsTask","CursorSelectionPathModeOptionTask"],primitives.orgdiagram.SelectionPathItemsTask,"#00ffff");f.addTask("NormalVisibilityItemsByForegroundShapeAnnotationTask",["ForegroundShapeAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByBackgroundShapeAnnotationTask",["BackgroundShapeAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,
"#00ffff");f.addTask("NormalVisibilityItemsByBackgroundAnnotationTask",["BackgroundAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByHighlightPathAnnotationTask",["HighlightPathAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByForegroundConnectorAnnotationTask",["ForegroundConnectorAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask,
...
primitives.orgdiagram.CombinedNormalVisibilityItemsTask,"#00ffff");f.addTask("ItemsPositionsTask","CurrentControlSizeTask ScaleOptionTask OrientationOptionTask ItemsSizesOptionTask ConnectorsOptionTask VisualTreeOptionTask OrgTreeTask IntervalsTask VisualTreeTask VisualTreeLevelsTask VisualTreeMarginsTask CombinedTemplateParamsTask CursorItemTask CombinedNormalVisibilityItemsTask".split(" "),primitives.orgdiagram.ItemsPositionsTask,"#ff0000");f.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask PrintPreviewOptionTask CurrentControlSizeTask VisualTreeTask VisualTreeLevelsTask ItemsPositionsTask isFamilyChartMode".split(" "),
...
primitives.orgdiagram.DrawConnectorsTask,"#008000");f.addTask("DrawItemLabelsTask","graphics CreateTransformTask ApplyLayoutChangesTask LabelsOptionTask VisualTreeLevelsTask AlignDiagramTask".split(" "),primitives.orgdiagram.DrawItemLabelsTask,"#008000");f.addTask("DrawPrintPreviewTask","graphics ApplyLayoutChangesTask PrintPreviewOptionTask AlignDiagramTask PrintPreviewTemplateTask ScaleOptionTask".split(" "),primitives.orgdiagram.DrawPrintPreviewTask,"#008000");return f},function(a,b,e,f){var g=
new primitives.famdiagram.EventArgs,h=a.tasks.getTask("CombinedContextsTask"),i=a.tasks.getTask("AlignDiagramTask"),j=a.tasks.getTask("AddLabelAnnotationsTask"),b=h.getConfig(b),k=h.getConfig(e),l=j.getNavigationFamily();b&&null!=b.id&&(g.oldContext=b);k&&null!=k.id&&(g.context=k,l.loopParents(this,k.id,function(a,b,c){if(0<c)return l.BREAK;g.parentItems.push(h.getConfig(a))}),j=a.layout.mousePanel.offset(),a=a.layout.element.offset(),e=i.getItemPosition(e),g.position=(new primitives.common.Rect(e.actualPosition)).translate(j.left,
j.top).translate(-a.left,-a.top));null!=f&&(g.name=f);return g})};
...
a,this.toItem=b}};primitives.orgdiagram.HighlightPathAnnotationConfig=function(a){var b;this.annotationType=2;this.items=[];this.selectItems=!1;switch(arguments.length){case 1:if(null!==a)if(a instanceof Array)this.items=a;else if("object"==typeof a)for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};
...
primitives.orgdiagram.ConnectorPoint.prototype=new primitives.common.Point;primitives.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};
...
primitives.orgdiagram.AlignDiagramTask=function(a,b,c,d,e,f,g,h,i,j){function k(a,b){var c=new primitives.common.Size(y.printPreviewPageSize),d,f,e;c.scale(1/w.scale);switch(u.orientationType){case 2:case 3:c.invert()}d=0;f=c.width;q.loopMerged(this,function(a){return r[a].actualPosition.x},function(b){var e=new primitives.orgdiagram.TreeItemPosition(r[b]);a[b]=e;e.actualPosition.left()+d<f&&e.actualPosition.right()+d>f&&(d+=f-e.actualPosition.left()-d+v.normalItemsInterval/2);e.actualPosition.translate(d,
0);e.actualPosition.left()>f&&(f+=c.width)});d=0;e=c.height;q.loopLevels(this,function(f){var g=new primitives.orgdiagram.TreeLevelPosition(s[f]);g.shift+d<e&&g.shift+g.depth+d>e&&(d+=e-g.shift-d+v.normalLevelShift/2);g.shiftDown(d);q.loopLevelItems(this,f,function(b){a[b].actualPosition.translate(0,d)});g.shift>e&&(e+=c.height);b.push(g)});return new primitives.common.Size(f+1,e+1)}var l={},m=[],p=null,t,q,n,r,s,v,u,y,A,w;return{process:function(){var B=new primitives.common.Size(i.getContentSize()),
D=new primitives.common.Size(f.getOptimalPanelSize());t=g.getVisualTree();q=h.getTreeLevels();n=h.getActiveTreeLevels();r=i.getItemsPositions();s=i.getTreeLevelsPositions();v=b.getOptions();u=a.getOptions();y=e.getOptions();A=c.getOptions();w=d.getOptions();switch(u.orientationType){case 2:case 3:D.invert()}D.scale(1/w.scale);p=D;l=r;m=s;switch(v.pageFitMode){case 4:l={};m=[];p=k(l,m);break;case 5:p=new primitives.common.Size(B);break;default:p=new primitives.common.Size(B);if(B.width<D.width){l=
{};var x=B.width,F=D.width,C;if(j)C=(F-x)/2;else switch(A.horizontalAlignment){case 1:C=0;break;case 2:C=F-x;break;case 0:C=(F-x)/2}var x=l,z;for(z in r)r.hasOwnProperty(z)&&(F=new primitives.orgdiagram.TreeItemPosition(r[z]),F.actualPosition.translate(C,0),x[z]=F);p.width=D.width}B.height<D.height&&(p.height=D.height)}switch(u.orientationType){case 2:case 3:p.invert()}return!0},getTreeLevelsPositions:function(){return m},getItemPosition:function(a){return l[a]},getItemsPositions:function(){return l},
getContentSize:function(){return p},getTreeItemForMousePosition:function(a,b){var c=null,d=w.scale,a=a/d,b=b/d;n.loopLevels(this,function(d){var f=m[d];if(b>f.shift+f.topConnectorShift&&b<=f.shift+f.connectorShift)return c=t.node(n.binarySearch(this,d,function(c){c=l[c];switch(c.actualVisibility){case 1:if(c.actualPosition.contains(a,b))return 0;case 2:case 3:return a-c.actualPosition.horizontalCenter();case 4:throw"Clickable items collection should contain only visible items.";}})),!0});return c},
getNextLevelTreeItem:function(a,b){var c=l[a].actualPosition.horizontalCenter(),d=a,f=null,e;n.loopLevelsFromItem(this,a,b,function(a){n.loopLevelItems(this,a,function(a){var b=l[a];if(1==b.actualVisibility)if(e=Math.abs(c-b.actualPosition.horizontalCenter()),e<f||null==f)f=e,d=a;else return!0});if(null!=f)return!0});return d},getNextTreeItem:function(a,b){var c=a.id,d;n.loopFromItem(this,a,b,function(a){d=r[a];if(1==d.actualVisibility)return c=a,!0});return c}}};
primitives.orgdiagram.ApplyLayoutChangesTask=function(a,b,c,d,e,f,g){var h=null,i,j;return{process:function(){var k=b(),l=a(),m=f.getOptions().scale;i=d.getOptions();j=c.getOptions();var p=new primitives.common.Size(g.getContentSize());p.scale(1*m);k.mousePanel.css(p.getCSS());var t=new primitives.common.Size(g.getContentSize());k.placeholder.css(t.getCSS());l.resize("placeholder",t.width,t.height);switch(i.pageFitMode){case 5:h=new primitives.common.Size(p.width+25,p.height+25);h.cropBySize(j.autoSizeMaximum);
h.addSize(j.autoSizeMinimum);k.element.css({width:h.width+"px",height:h.height+"px"});break;case 4:h=new primitives.common.Size(p.width+25,p.height+25);k.element.css({width:h.width+"px",height:h.height+"px"});break;default:h=new primitives.common.Size(e.getScrollPanelSize())}l=k.element.offset();k.scrollPanel.css({top:"0px",left:"0px",width:h.width+"px",height:h.height+"px","margin-bottom":"0px","margin-right":"0px","margin-top":-l.top+Math.floor(l.top)+"px","margin-left":-l.left+Math.floor(l.left)+
...
primitives.orgdiagram.CenterOnCursorTask=function(a,b,c,d,e,f,g){function h(a){var b=!1;j.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,c,d,f){b=new primitives.common.Rect(a,c,d,f)});return b}var i=null,j;return{process:function(){var k;k=a();var l=d.getCursorTreeItem(),m=e.getItemPosition(l),l=g.getOptions().scale;i=c.getPlaceholderOffset();k.forceCenterOnCursor&&(j=f.getTransform(),null!=m&&(k=h(m.actualPosition),k.scale(l),l=b.getScrollPanelSize(),i=new primitives.common.Point(Math.max(k.horizontalCenter()-
...
"number"],!0),!1),selectItems:new primitives.common.ValueReader(["boolean"],!1,c.selectItems)},!1));return{process:function(){var b={isChanged:!1,hash:f};d=g.read(d,a.getAnnotations(2,null),"options",b);e=h.read(e,a.getAnnotations(2,null),"annotations",b);return b.isChanged},getAnnotations:function(){return e},getHighlighPathOptions:function(){return d}}};
...
primitives.orgdiagram.SplitAnnotationsOptionTask=function(a){var b={};return{process:function(){var c=a.getOptions().annotations,d,e,f,g,h,i={};if(Array.isArray(c)){d=0;for(e=c.length;d<e;d+=1){f=c[d];g=f.annotationType;switch(g){case 1:case 0:switch(f.zOrderType){case 1:h=1;break;default:h=2}break;default:h=null}null!=g&&(g=1E3*g+(h||0),i.hasOwnProperty(g)||(i[g]=[]),i[g].push(f))}}b=i;return!0},getAnnotations:function(a,d){return b[1E3*a+(d||0)]}}};
...
primitives.orgdiagram.DrawBackgroundAnnotationTask=function(a,b,c,d,e,f,g){function h(a,b,c){var d,e,g,h,r,s,v,u,y,A,w;d=0;for(e=a.length;d<e;d+=1)if(w=a[d],null!=w.items&&0<w.items.length){r=new primitives.common.Perimeter(i);r.transform=j;s=new primitives.orgdiagram.BackgroundAnnotationConfig;y=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=y.length;g<h;g+=1)A=y[g],r[A]=w.hasOwnProperty(A)?w[A]:s[A];i.activate("placeholder",2);v=[];u={};if(w.includeChildren){g=0;for(h=w.items.length;g<
h;g+=1)s=w.items[g],y=f.getItemPosition(s),null!=y&&(u[s]=!0,v.push(s),c.loopChildren(this,s,function(a){u[a]||(u[a]=!0,v.push(a))}))}else v=w.items;w=b.getMergedPerimeters(v);for(g=0;g<w.length;g+=1)r.draw(w[g])}}var i,j;return{process:function(){var c=d.getAnnotations(),f,m;i=a();i.reset("placeholder",2);0<c.length&&(j=b.getTransform(),f=g.getBackgroundManager(),m=e.getNavigationFamily(),h(c,f,m));return!1}}};
primitives.orgdiagram.DrawConnectorAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,y,A,w=new primitives.common.PolylinesBuffer,B=primitives.orgdiagram.ConnectorAnnotationOffsetResolver(),D=0;switch(h){case 1:j.activate("placeholder",4);break;case 2:j.activate("placeholder",12)}c=0;for(d=a.length;c<d;c+=1)y=a[c],D=Math.max(D,y.lineWidth);c=0;for(d=a.length;c<d;c+=1)if(y=a[c],null!=y.fromItem&&null!=y.toItem&&(f=b(y.fromItem),e=b(y.toItem),null!=f&&null!=e)){f=f.actualPosition;
g=e.actualPosition;switch(y.connectorPlacementType){case 0:i=new primitives.common.ConnectorOffbeat;break;case 1:i=new primitives.common.ConnectorStraight}var x;k.transformRect(0,0,y.labelSize.width,y.labelSize.height,!1,this,function(a,b,c,d){x=new primitives.common.Size(c,d)});var F=null;k.transformRect(0,0,m.width,m.height,!1,this,function(a,b,c,d){F=new primitives.common.Size(c,d)});e=new primitives.common.PaletteItem({lineColor:y.color,lineWidth:y.lineWidth,lineType:y.lineType});var C=!primitives.common.isNullOrEmpty(y.label);
f=(new primitives.common.Rect(f)).offset(y.offset);g=(new primitives.common.Rect(g)).offset(y.offset);i.draw(w,e,f,g,3*y.lineWidth,6*D,x,F,y.connectorShapeType,4,y.labelPlacementType,C,B,function(a){C&&null!=a&&(k.transformRect(a.x,a.y,a.width,a.height,!0,this,function(b,c,d,f){a=new primitives.common.Rect(b,c,d,f)}),A=new primitives.common.RenderEventArgs,A.context=y,j.template(a.x,a.y,0,0,0,0,a.width,a.height,l.template(),l.getHashCode(),l.render,A,null))})}B.resolve();w.transform(k,!0);j.polylinesBuffer(w)}
var j,k,l,m;return{process:function(){j=a();k=b.getTransform();d.getOptions();l=g.getTemplate();m=new primitives.common.Size(f.getContentSize());switch(h){case 1:j.reset("placeholder",4);break;case 2:j.reset("placeholder",12)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawConnectorsTask=function(a,b,c,d,e,f,g,h,i,j,k){function l(a){var b=n.activate("placeholder",5),c;v.hasNodes()&&(c=new primitives.common.PolylinesBuffer,u.loopLevels(this,function(d){var f=y[d];u.loopLevelItems(this,d,function(d){var e=v.node(d);m(b.hasGraphics,c,w,e,A[d],f,a)})}),n.polylinesBuffer(c))}function m(a,b,c,d,f,e,g){var k,j,l,m,n,q,B,w,W,aa,V,N,T,O,S=0,H,X=0===s.connectorType,da,ga;O=0<f.partnerConnectorOffset?e.shift+e.connectorShift-e.levelSpace/2*(e.partnerConnectorOffset-
f.partnerConnectorOffset+1):d.connectorPlacement&4?f.actualPosition.bottom():e.shift+e.connectorShift;1>=f.partnerConnectorOffset?c.selectPalette(0):1<f.partnerConnectorOffset?c.selectPalette(f.partnerConnectorOffset-1):c.selectPalette(e.partnerConnectorOffset);v.hasChildren(d.id)&&(k=4===f.actualVisibility&&null==v.parentid(d.id),T=f.actualPosition.horizontalCenter());l=[];var U=i.getOrgPartners(d.id);if(1<d.partners.length||0<U.length){f=d.partners;0===d.partners.length&&f.push(d.id);for(w=0;w<
f.length;w+=1)m=f[w],v.node(m),q=h.getHighlightPath(m),n=A[m],H=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter(),n.actualPosition.bottom()),H.isSquared=!0,H.highlightPath=q.partnerHighlightPath,H.connectorStyleType=q.partnerHighlightPath?2:1,H.visibility=n.actualVisibility,l.push(H);f=U;for(w=0;w<f.length;w+=1)m=f[w],v.node(m),q=h.getHighlightPath(m),n=A[m],H=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter(),n.actualPosition.bottom()),H.isSquared=
!0,H.highlightPath=q.partnerHighlightPath,H.connectorStyleType=q.partnerHighlightPath?2:0,H.visibility=n.actualVisibility,l.push(H);0<l.length&&(l.sort(function(a,b){return a.x-b.x}),v.hasChildren(d.id)||(T=(l[0].x+l[l.length-1].x)/2),b.addInverted(function(b){t(b,c,T,O,l,!0,a,1==s.arrowsDirection)}))}j=[];v.hasChildren(d.id)&&(N=!1,v.loopChildren(this,d.id,function(d,f){B=y[u.getLevelIndex(d)];n=A[d];q=h.getHighlightPath(d);da=c.getPalette(q.highlightPath?2:1);ga=b.getPolyline(da);if(f.connectorPlacement&
8)W=A[u.getPrevItem(d)],r.transformPoints(n.actualPosition.x,B.shift+B.horizontalConnectorsDepth,W.actualPosition.right(),B.shift+B.horizontalConnectorsDepth,!0,this,function(a,c,d,f){p(a,c,d,f,b,ga,n.actualVisibility,W.actualVisibility)});else if(f.connectorPlacement&2)aa=A[u.getNextItem(d)],r.transformPoints(n.actualPosition.right(),B.shift+B.horizontalConnectorsDepth,aa.actualPosition.x,B.shift+B.horizontalConnectorsDepth,!0,this,function(a,c,d,f){p(a,c,d,f,b,ga,n.actualVisibility,aa.actualVisibility)});
else if(f.connectorPlacement&1&&!k){V=!0;if(a)switch(n.actualVisibility){case 2:case 3:V=X}H=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter()+0,n.actualPosition.top());H.isSquared=V;H.connectorStyleType=q.highlightPath?2:1;H.visibility=n.actualVisibility;j.push(H);S=Math.max(S,H.connectorStyleType);N=N||H.isSquared}}),!k&&0<j.length&&(r.transformPoints(T,O,T,e.shift+e.connectorShift,!0,this,function(a,f,e,h){var k=Math.round(s.elbowDotSize/2),i=c.getPalette(S),m=b.getPolyline(i),
m=b.getPolyline(m.arrowPaletteItem);g&&(0!=s.elbowType&&0<d.partners.length)&&m.addSegment(new primitives.common.DotSegment(a-k,f-k,2*k,2*k,k));b.addInverted(function(c){c=c.getPolyline(i);c.addSegment(new primitives.common.MoveSegment(e,h));c.addSegment(new primitives.common.LineSegment(a,f));1==s.arrowsDirection&&(4!==d.visibility&&1>=l.length)&&c.addArrow(s.linesWidth,function(a){a.mergeTo(b.getPolyline(a.paletteItem))})});g&&(0!==s.elbowType&&1<j.length)&&m.addSegment(new primitives.common.DotSegment(e-
k,h-k,2*k,2*k,k))}),t(b,c,T,e.shift+e.connectorShift,j,N,a,2==s.arrowsDirection)))}function p(a,b,c,d,f,e,g,h){a=new primitives.common.Point(a,b);c=new primitives.common.Point(c,d);d=!1;switch(s.arrowsDirection){case 1:4!=h&&(d=!0);break;case 2:4!=g&&(a.swap(c),d=!0)}e.addSegment(new primitives.common.MoveSegment(a));e.addSegment(new primitives.common.LineSegment(c));d&&e.addArrow(s.linesWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})}function t(a,b,c,d,f,e,g,h){var k,j,l,i=[],m,p,u;if(e){i=
[];e=0;for(j=f.length;e<j;e+=1)if(l=f[e],l.x<c&&!l.isSquared)i.push(l);else break;j=i.length;0<j&&q(a,b,c,d,i,!1,h);i=[];for(k=f.length-1;k>=e;k-=1)if(l=f[k],l.x>c&&!l.isSquared)i.push(l);else break;j=i.length;0<j&&q(a,b,c,d,i,!1,h);i={};j={};for(p in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(p)&&(i[primitives.common.ConnectorStyleType[p]]=c,j[primitives.common.ConnectorStyleType[p]]=c);for(p=e;p<=k;p+=1){l=f[p];m=b.getPalette(l.connectorStyleType);u=
a.getPolyline(m);m=s.bevelSize;2>m&&(m=0);if(g)switch(s.elbowType){case 2:case 3:0<m&&(Math.abs(c-l.x)>m&&Math.abs(d-l.y)>m)&&(l.hasElbow=!0,l.elbowPoint1=new primitives.common.Point(l.x,d+(d>l.y?-m:m)),l.elbowPoint2=new primitives.common.Point(l.x+(c>l.x?m:-m),d));break;case 1:0<k-e&&r.transformPoints(l.x,d,l.x,l.y,!0,this,function(b,c){var d=Math.round(s.elbowDotSize/2);a.getPolyline(u.arrowPaletteItem).addSegment(new primitives.common.DotSegment(b-d,c-d,2*d,2*d,d))})}i[l.connectorStyleType]=Math.min(i[l.connectorStyleType],
l.hasElbow?l.elbowPoint2.x:l.x);j[l.connectorStyleType]=Math.max(j[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x)}m=[Math.max(0,e-1),Math.min(k+1,f.length-1)];for(p=0;p<m.length;p+=1)l=f[m[p]],i[l.connectorStyleType]=Math.min(i[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x),j[l.connectorStyleType]=Math.max(j[l.connectorStyleType],l.hasElbow?l.elbowPoint2.x:l.x);l=c;for(p=2;0<=p;p-=1)m=b.getPalette(p),u=a.getPolyline(m),m=i[p],null!=m&&m<l&&(r.transformPoints(l,d,m,d,!0,this,function(a,
b,c,d){u.addSegment(new primitives.common.MoveSegment(a,b));u.addSegment(new primitives.common.LineSegment(c,d))}),l=m),m=j[p],null!=m&&m>c&&(r.transformPoints(c,d,m,d,!0,this,function(a,b,c,d){u.addSegment(new primitives.common.MoveSegment(a,b));u.addSegment(new primitives.common.LineSegment(c,d))}),c=m);for(p=e;p<=k;p+=1)l=f[p],m=b.getPalette(l.connectorStyleType),u=a.getPolyline(m),l.hasElbow?(r.transform3Points(l.elbowPoint2.x,l.elbowPoint2.y,l.elbowPoint1.x,l.elbowPoint2.y,l.elbowPoint1.x,l.elbowPoint1.y,
!0,this,function(a,b,c,d,f,e){switch(s.elbowType){case 2:u.addSegment(new primitives.common.MoveSegment(a,b));u.addSegment(new primitives.common.LineSegment(f,e));break;case 3:u.addSegment(new primitives.common.MoveSegment(a,b)),u.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}}),r.transformPoints(l.elbowPoint1.x,l.elbowPoint1.y,l.x,l.y,!0,this,function(a,b,c,d){u.addSegment(new primitives.common.LineSegment(c,d))})):r.transformPoints(l.x,d,l.x,l.y,!0,this,function(a,b,c,d){u.addSegment(new primitives.common.MoveSegment(a,
b));u.addSegment(new primitives.common.LineSegment(c,d))}),g&&(h&&4!=l.visibility)&&u.addArrow(s.linesWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})}else q(a,b,c,d,f,!0,h)}function q(a,b,c,d,f,e,g){var h=null,k=f.length,j,l,i,m,h=e?c:f[k-1].x;l=new primitives.common.Point(h,d);for(c=0;c<k;c+=1){i=f[c];j=b.getPalette(i.connectorStyleType);m=a.getPolyline(j);r.transformPoint(h,d,!0,this,function(a,b){m.addSegment(new primitives.common.MoveSegment(a,b))});switch(s.connectorType){case 1:r.transformPoint(i.x,
i.y,!0,this,function(a,b){m.addSegment(new primitives.common.LineSegment(a,b))});break;case 2:j=new primitives.common.Rect(l,i),e?h>j.x?r.transform3Points(j.right(),j.verticalCenter(),j.x,j.verticalCenter(),j.x,j.bottom(),!0,this,function(a,b,c,d,f,e){m.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):r.transform3Points(j.x,j.verticalCenter(),j.right(),j.verticalCenter(),j.right(),j.bottom(),!0,this,function(a,b,c,d,f,e){m.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,
e))}):h>j.x?r.transformPoints(j.x,j.y,j.x,j.bottom(),!0,this,function(a,b,c,d){m.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):r.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(a,b,c,d){m.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}g&&4!=i.visibility&&m.addArrow(s.linesWidth,function(b,c){var d;b.mergeTo(a.getPolyline(b.paletteItem));B&&(d=a.getPolyline({fillColor:"#ff0000"}),d.addSegment(new primitives.common.DotSegment(c.x-1,c.y-1,2,2,
1)))})}}var n,r,s,v,u,y,A,w,B=!1;return{process:function(){n=a();r=b.getTransform();s=d.getOptions();v=e.getVisualTree();u=f.getTreeLevels();y=g.getTreeLevelsPositions();A=g.getItemsPositions();w=k.getPaletteManager();n.reset("placeholder",5);l(j);return!1}}};
primitives.orgdiagram.DrawCursorTask=function(a,b,c,d,e,f,g,h){function i(a){var b;j.activate("placeholder",9);var c=e.getItemPosition(a),g=c.actualPosition,i=new primitives.common.Rect(c.contentPosition),n=f.getTemplateParams(a).template,r=n.templateConfig,c=r.cursorPadding;i.offset(c.left,c.top,c.right,c.bottom);b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=!0;b.isSelected=h.isSelected(a);b.templateName=r.name;k.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,
c,d,f){j.template(a,c,d,f,i.x,i.y,i.width,i.height,n.cursorTemplate.template(),n.cursorTemplate.getHashCode(),n.cursorTemplate.render,b,{"border-width":r.cursorBorderWidth})})}var j,k;return{process:function(){var c=g.getCursorTreeItem();j=a();j.reset("placeholder",9);null!=c&&(k=b.getTransform(),i(c));return!1}}};
primitives.orgdiagram.DrawHighlightAnnotationTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m){function p(a){var b,c,k,p,B,D,x=!0,F,C=i.getItemPosition(a),z=C.actualPosition;switch(C.actualVisibility){case 2:case 3:case 1:b=g.getItemOptions(a);switch(b.showCallout){case 2:x=!1;break;case 1:x=!1;break;default:x=r.showCallout}x?(t.activate("placeholder",10),q.transformRect(z.x,z.y,z.width,z.height,!0,this,function(g,q,x,z){var q=new primitives.common.Rect(g,q,x,z),g=new primitives.common.Point(q.horizontalCenter(),
q.verticalCenter()),x=e.getOptions().scale,z=new primitives.common.Point(j.getPlaceholderOffset()),I=i.getContentSize(),M=d.getOptimalPanelSize();z.scale(1/x);M.scale(1/x);x=new primitives.common.Rect(z.x,z.y,Math.min(M.width,I.width),Math.min(M.height,I.height));1!=C.actualVisibility||!x.overlaps(q)?(B=!primitives.common.isNullOrEmpty(b.calloutTemplateName)?b.calloutTemplateName:!primitives.common.isNullOrEmpty(b.templateName)?b.templateName:!primitives.common.isNullOrEmpty(r.defaultCalloutTemplateName)?
r.defaultCalloutTemplateName:r.defaultTemplateName,D=h.getTemplate(B,h.DefaultWidgetTemplateName),q=D.templateConfig.itemSize,z=new primitives.common.Rect(g.x,g.y,q.width,q.height),g.y>x.bottom()-x.height/4?(z.y-=q.height/2,z.x=g.x<x.horizontalCenter()?z.x+q.width/4:z.x-(q.width/4+q.width)):(z.y+=q.height/4,z.x-=q.width/2),z.x<x.x?z.x=x.x+5:z.right()>x.right()&&(z.x-=z.right()-x.right()+5),z.y<x.y?z.y=x.y+5:z.bottom()>x.bottom()&&(z.y-=z.bottom()-x.bottom()+5),k=z,c=new primitives.common.Rect(k),
c.addRect(g.x,g.y),c.offset(50),F=c.getCSS(),F.display="inherit",F.visibility="inherit",s.calloutPlaceholder.css(F),g.x-=c.x,g.y-=c.y,k.x-=c.x,k.y-=c.y,p=new primitives.common.RenderEventArgs,p.context=f.getConfig(a),p.isCursor=l.getCursorTreeItem()==a,p.isSelected=m.isSelected(a),p.templateName=D.templateConfig.name,t.resize("calloutplaceholder",c.width,c.height),t.activate("calloutplaceholder",13),t.template(k.x,k.y,k.width,k.height,0,0,k.width,k.height,D.itemTemplate.template(),D.itemTemplate.getHashCode(),
D.itemTemplate.render,p,null),n.pointerPlacement=0,n.cornerRadius=r.calloutCornerRadius,n.offset=r.calloutOffset,n.opacity=r.calloutOpacity,n.lineWidth=r.calloutLineWidth,n.pointerWidth=r.calloutPointerWidth,n.borderColor=r.calloutBorderColor,n.fillColor=r.calloutfillColor,n.draw(g,k)):s.calloutPlaceholder.css({display:"none",visibility:"hidden"})})):s.calloutPlaceholder.css({display:"none",visibility:"hidden"});break;case 4:s.calloutPlaceholder.css({display:"none",visibility:"hidden"})}}var t,q,
n=new primitives.common.Callout(b()),r,s;return{process:function(){var d=k.getHighlightTreeItem();t=b();t.reset("calloutplaceholder",13);null!==d&&(q=c.getTransform(),r=g.getOptions(),s=a(),p(d));return!1}}};
...
j(c));return!1}}};
primitives.orgdiagram.DrawItemLabelsTask=function(a,b,c,d,e,f){function g(){var a,b,c,e,g,n,r,s=[];j.loopLevels(this,function(a){var c=[];j.loopLevelItems(this,a,function(a){var e=d.getItemOptions(a),g=f.getItemPosition(a),a=g.actualPosition;null!=e&&i.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,d,f,h){switch(g.actualVisibility){case 1:0==k.showLabels&&(b=new primitives.common.Label,b.text="dummy",b.position=new primitives.common.Rect(a,d,f,h),b.weight=1E4,b.labelType=1,c.push(b));break;
case 2:var j,l,i=null,p=k.labelOffset,u,n;if(!primitives.common.isNullOrEmpty(e.label)){switch(e.showLabel){case 0:switch(k.showLabels){case 0:switch(g.actualVisibility){case 3:case 2:i=new primitives.common.Label,i.labelType=0,i.weight=g.leftPadding+g.rightPadding}break;case 1:i=new primitives.common.Label,i.labelType=2,i.weight=1E4}break;case 1:i=new primitives.common.Label,i.weight=1E4,i.labelType=2}if(null!=i){i.text=e.label;u=null!=e.labelSize?e.labelSize:k.labelSize;i.labelOrientation=3!=e.labelOrientation?
e.labelOrientation:3!=k.labelOrientation?k.labelOrientation:0;n=0!=e.labelPlacement?e.labelPlacement:0!=k.labelPlacement?k.labelPlacement:1;switch(i.labelOrientation){case 0:j=u.width;l=u.height;break;case 1:case 2:l=u.width,j=u.height}switch(n){case 0:case 1:i.position=new primitives.common.Rect(a+f/2-j/2,d-p-l,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=0;i.verticalAlignmentType=2;break;case 1:i.horizontalAlignmentType=1;i.verticalAlignmentType=1;break;case 2:i.horizontalAlignmentType=
2,i.verticalAlignmentType=1}break;case 2:case 11:i.position=new primitives.common.Rect(a+f+p,d-p-l,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=1;i.verticalAlignmentType=2;break;case 1:i.horizontalAlignmentType=1;i.verticalAlignmentType=0;break;case 2:i.horizontalAlignmentType=2,i.verticalAlignmentType=2}break;case 3:i.position=new primitives.common.Rect(a+f+p,d+h/2-l/2,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=1;i.verticalAlignmentType=1;break;case 1:i.horizontalAlignmentType=
0;i.verticalAlignmentType=0;break;case 2:i.horizontalAlignmentType=0,i.verticalAlignmentType=2}break;case 4:case 12:i.position=new primitives.common.Rect(a+f+p,d+h+p,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=1;i.verticalAlignmentType=0;break;case 1:i.horizontalAlignmentType=2;i.verticalAlignmentType=0;break;case 2:i.horizontalAlignmentType=1,i.verticalAlignmentType=2}break;case 5:i.position=new primitives.common.Rect(a+f/2-j/2,d+h+p,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=
0;i.verticalAlignmentType=0;break;case 1:i.horizontalAlignmentType=2;i.verticalAlignmentType=1;break;case 2:i.horizontalAlignmentType=1,i.verticalAlignmentType=1}break;case 6:case 10:i.position=new primitives.common.Rect(a-j-p,d+h+p,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=2;i.verticalAlignmentType=0;break;case 1:i.horizontalAlignmentType=2;i.verticalAlignmentType=2;break;case 2:i.horizontalAlignmentType=1,i.verticalAlignmentType=0}break;case 7:i.position=new primitives.common.Rect(a-
j-p,d+h/2-l/2,j,l);switch(i.labelOrientation){case 0:i.horizontalAlignmentType=2;i.verticalAlignmentType=1;break;case 1:i.horizontalAlignmentType=0;i.verticalAlignmentType=2;break;case 2:i.horizontalAlignmentType=0,i.verticalAlignmentType=0}break;case 8:case 9:switch(i.position=new primitives.common.Rect(a-j-p,d-p-l,j,l),i.labelOrientation){case 0:i.horizontalAlignmentType=2;i.verticalAlignmentType=2;break;case 1:i.horizontalAlignmentType=1;i.verticalAlignmentType=2;break;case 2:i.horizontalAlignmentType=
2,i.verticalAlignmentType=0}}}}b=i;null!=b&&c.push(b)}})});s[a]=c});var v=[],u=[],y=[];0==k.showLabels&&(j.loopLevels(this,function(a){var b=s[a],c,d,f=!1;e=0;for(n=b.length;e<n;e+=1)c=b[e],null==d?d=new primitives.common.Rect(c.position):d.addRect(c.position),f=f||2==c.labelType;v[a]=d;u[a]=f}),j.loopLevelsReversed(this,function(a){var b=v[a-1],c=v[a];y[a]=!0;null!=b&&null!=c&&b.overlaps(c)&&(y[a]=!1)}),j.loopLevels(this,function(d){a=s[d];if(y[d]){e=0;for(n=a.length;e<n;e+=1)if(b=a[e],b.isActive)for(g=
e+1;g<n;g+=1)if(c=a[g],c.isActive)if(b.position.overlaps(c.position))if(b.weight>=c.weight)0==c.labelType&&(c.isActive=!1);else{0==b.labelType&&(b.isActive=!1);break}else break}}));h.activate("placeholder",8);r={"font-size":k.labelFontSize,"font-family":k.labelFontFamily,"font-style":k.labelFontStyle,"font-weight":k.labelFontWeight,"font-color":k.labelColor};j.loopLevels(this,function(a){if(1==k.showLabels||y[a]||u[a]){a=s[a];e=0;for(n=a.length;e<n;e+=1)if(b=a[e],b.isActive)switch(b.labelType){case 0:case 2:h.text(b.position.x,
...
primitives.orgdiagram.DrawMinimizedItemsTask=function(a,b,c,d,e,f,g){function h(){var a=new primitives.common.PolylinesBuffer,b={},c,e=new primitives.common.Marker,h,s,v,u;m.loop(this,function(i){var m=d.getItemOptions(i),w=g.getItemPosition(i),B=w.actualPosition,D,x;j.transformRect(B.x,B.y,B.width,B.height,!0,this,function(d,g,j,B){switch(w.actualVisibility){case 2:D=f.getTemplateParams(i);x=D.template.templateConfig;v=s=h=null;u=0;null!=m&&(s=h=m.itemTitleColor,v=m.minimizedItemShapeType);h=h||
x.minimizedItemBorderColor||"#000080";s=s||x.minimizedItemFillColor||"#000080";null==v&&(v=null!==x.minimizedItemShapeType?x.minimizedItemShapeType:l.minimizedItemShapeType);u=null===x.minimizedItemCornerRadius?x.minimizedItemSize.width/2:x.minimizedItemCornerRadius;null==v||6==v?(c=a.getPolyline(new primitives.common.PaletteItem({lineColor:h,lineWidth:x.minimizedItemLineWidth,lineType:x.minimizedItemLineType,fillColor:s,opacity:x.minimizedItemOpacity})),c.addSegment(new primitives.common.DotSegment(d,
g,j,B,u))):e.draw(a,v,new primitives.common.Rect(d,g,j,B),new primitives.common.PaletteItem({lineColor:h,lineWidth:x.minimizedItemLineWidth,lineType:x.minimizedItemLineType,fillColor:s,opacity:x.minimizedItemOpacity}));break;default:k&&(h="#ff0000",b.hasOwnProperty(h)||(b[h]=new primitives.common.PaletteItem({lineColor:h,lineWidth:1,lineType:0,fillColor:h,opacity:1})),c=a.getPolyline(b[h]),c.addSegment(new primitives.common.DotSegment(d-1,g-1,2,2,1)))}})});i.activate("placeholder",7);i.polylinesBuffer(a)}
var i,j,k,l,m;return{process:function(){i=a();j=b.getTransform();m=e.getVisualTree();l=d.getOptions();i.reset("placeholder",7);h();return!1}}};
...
primitives.orgdiagram.DrawShapeAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,y,A,w,B,D,x;switch(h){case 1:c=j.activate("placeholder",3);break;case 2:c=j.activate("placeholder",11)}d=0;for(f=a.length;d<f;d+=1)if(D=a[d],null!=D.items&&0<D.items.length){A=new primitives.common.Rect;e=0;for(g=D.items.length;e<g;e+=1)y=b(D.items[e]),null!=y&&A.addRect(y.actualPosition);if(!A.isEmpty()){i=new primitives.common.Shape(j);y=new primitives.orgdiagram.ShapeAnnotationConfig;w="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");
e=0;for(g=w.length;e<g;e+=1)B=w[e],i[B]=D.hasOwnProperty(B)?D[B]:y[B];i.position=A;i.orientationType=l.orientationType;i.panelSize=c.size;i.labelTemplate=m;i.hasLabel=null!=D.templateName||null!=D.label;x=new primitives.common.RenderEventArgs;x.context=D;x.templateName=i.labelTemplate;k.transformRect(A.x,A.y,A.width,A.height,!0,this,function(a,b,c,d){a=new primitives.common.Rect(a,b,c,d);i.draw(a,x)})}}}var j,k,l,m;return{process:function(){j=a();k=b.getTransform();l=d.getOptions();m=g.getTemplate();
switch(h){case 1:j.reset("placeholder",3);break;case 2:j.reset("placeholder",11)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawTreeItemsTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m){function p(){var a,b=i.getCursorTreeItem();t.loop(this,function(c){var d=q[c],f=d.actualPosition;1==d.actualVisibility&&r.transformRect(f.x,f.y,f.width,f.height,!0,this,function(f,g,i,k){var l=h.getTemplateParams(c),m=l.template;a=new primitives.common.RenderEventArgs;a.context=e.getConfig(c);a.isCursor=c==b;a.isSelected=j.isSelected(c);a.templateName=m.templateConfig.name;n.activate("placeholder",10);n.template(f,g,i,k,d.contentPosition.x,
d.contentPosition.y,d.contentPosition.width,d.contentPosition.height,m.itemTemplate.template(),m.itemTemplate.getHashCode(),m.itemTemplate.render,a,{"border-width":m.templateConfig.itemBorderWidth});l.hasGroupTitle&&n.template(f,g,i,k,2,d.contentPosition.y,s.groupTitlePanelSize-4,d.contentPosition.height+2,y.template(),y.getHashCode(),y.render,a,null);l.hasSelectorCheckbox&&(n.activate("placeholder",14),n.template(f,g,i,k,d.contentPosition.x,k-(s.checkBoxPanelSize-4),d.contentPosition.width,s.checkBoxPanelSize-
4,u.template(),u.getHashCode(),u.render,a,null));l.hasButtons&&(n.activate("placeholder",14),n.template(f,g,i,k,i-(s.buttonsPanelSize-4),d.contentPosition.y,s.buttonsPanelSize-4,Math.max(d.contentPosition.height,k-d.contentPosition.y),v.template(),m.templateConfig.name+v.getHashCode(),v.render,l,null))})})}var t,q,n,r,s,v,u,y;return{process:function(){n=a();s=d.getOptions();t=f.getVisualTree();q=g.getItemsPositions();r=b.getTransform();v=m.getTemplate();u=l.getTemplate();y=k.getTemplate();n.reset("placeholder",
10);n.reset("placeholder",14);p();return!1}}};primitives.orgdiagram.AnnotationLabelTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.AnnotationLabelTemplate);return a}}};primitives.orgdiagram.ButtonsTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.ButtonsTemplate);return a}}};
...
primitives.orgdiagram.ItemTemplateParamsTask=function(a,b,c){function d(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d}var e={};return{process:function(){var f=a.getOptions(),g=0<f.buttons.length,h=b.getCursorItem(),i=f.items,j,k;e={};j=0;for(k=i.length;j<k;j+=1){var l=i[j],m=new primitives.orgdiagram.TemplateParams,p=h==l.id,t=c.getTemplate(l.templateName,f.defaultTemplateName,c.DefaultWidgetTemplateName),q=t.templateConfig,
n=null!=q.buttons&&0<q.buttons.length;m.template=t;m.hasSelectorCheckbox=d(p,l.hasSelectorCheckbox,f.hasSelectorCheckbox);m.hasButtons=(g||n)&&d(p,l.hasButtons,f.hasButtons);m.hasGroupTitle=!primitives.common.isNullOrEmpty(l.groupTitle);m.isActive=l.isActive&&q.isActive;m.hasButtons&&(m.buttons=n?q.buttons:f.buttons);e[l.id]=m}return!0},getTemplateParams:function(a){return e[a]}}};
...
primitives.orgdiagram.CombinedNormalVisibilityItemsTask=function(a,b,c,d,e,f,g,h,i,j,k){function l(a){var b=[],c,d,f,e,g,j,h={};c=0;for(d=a.length;c<d;c+=1){f=a[c];g=f.getItems();f=0;for(e=g.length;f<e;f+=1)j=g[f],h.hasOwnProperty(j)||(b.push(j),h[j]=!0)}return b}var m=[],p={},t=[b,c,d,e,f,g,h,i,j,k],q=new primitives.common.ArrayReader(new primitives.common.ValueReader(["string","number"],!0),!0);return{process:function(){var b={isChanged:!1,hash:p},c=a.getOptions();m=q.read(m,l(t),"items",b);if(0==
...
primitives.orgdiagram.SelectionPathItemsTask=function(a,b,c,d){function e(a,b,c){var d=[],f={},e,m,p;m=0;for(p=a.length;m<p;m+=1)switch(e=a[m],c){case 1:b.loopParents(this,e,function(a){if(null!=f[a])return b.SKIP;d.push(a);f[a]=!0})}return d}var f=[];return{process:function(){var g=d.getSelectionPathMode(),h=a.getNavigationFamily(),i=b.getCursorTreeItem(),j=c.getItems().slice(0);j.push(i);f=e(j,h,g);return!0},getItems:function(){return f}}};
primitives.orgdiagram.BackgroundAnnotationManagerTask=function(a,b,c,d){function e(){var a=new primitives.common.perimeter.Manager,b,c,d,e,h,i,p,A,w,B,D,x,F,C,z;if(!k.isEmpty()&&(p=[],A=[],k.loopLevels(this,function(a){D=B=null;z=l[a];4!=z.actualVisibility&&(p.push(a),F=[],k.loopLevelItems(this,a,function(a){var b=j.node(a);x=m[a];4!=x.actualVisibility&&null!=b&&(null!=D&&g(F,B,D,x),B=D,D=x)}),null!=D&&g(F,B,D,null),A.push(F))}),0<A.length)){w=[];h=[];b=0;for(c=A.length;b<c;b+=1)h=primitives.common.mergeSort([h,
A[b]],null,!0),w.push(h),h=A[b];w.push(primitives.common.mergeSort([A[b-1]],null,!0));h=[];b=0;for(c=w.length;b<c;b+=1){i={};F=w[b];d=0;for(e=F.length;d<e;d+=1)C=F[d],i[C]=d;h.push(i)}d=[];i=C=null;b=0;for(c=p.length;b<c;b+=1)e=p[b],null!=i&&f(d,b-1,h,w,l[C],i,l[i],l[e]),C=i,i=e;null!=i&&f(d,b-1,h,w,l[C],i,l[i],null);a.add(d)}return a}function f(a,b,c,d,f,e,g,i){var l=Math.floor(p.normalItemsInterval/2),w=null!=f?Math.floor(3*(f.shift+f.depth)/7+4*g.shift/7):g.shift-l,B=null!=i?Math.floor(3*(g.shift+
g.depth)/7+4*i.shift/7):g.shift+g.depth+l,D=null,x=null,F,C,z;k.loopLevelItems(this,e,function(f){z=j.node(f);F=m[f];4!=F.actualVisibility&&null!=z&&(null!=x&&h(a,c[b],c[b+1],d[b],d[b+1],w,B,D,x,F,C.id),D=x,x=F,C=z)});null!=x&&h(a,c[b],c[b+1],d[b],d[b+1],w,B,D,x,null,C.id)}function g(a,b,c,d){var f=Math.floor(p.normalItemsInterval/2),b=null!=b?Math.floor(3*b.actualPosition.right()/7+4*c.actualPosition.x/7):c.actualPosition.x-f,c=null!=d?Math.floor(3*c.actualPosition.right()/7+4*d.actualPosition.x/
7):c.actualPosition.right()+f;a.push(b);a.push(c)}function h(a,b,c,d,f,e,g,h,j,k,i){var l=[],m=primitives.common.perimeter.SegmentItem,F=Math.floor(p.normalItemsInterval/2),h=null!=h?Math.floor(3*h.actualPosition.right()/7+4*j.actualPosition.x/7):j.actualPosition.x-F,j=null!=k?Math.floor(3*j.actualPosition.right()/7+4*k.actualPosition.x/7):j.actualPosition.right()+F;l.push(new m(h,e,h,g));for(k=c[h]+1;k<=c[j];k+=1)l.push(new m(f[k-1],g,f[k],g));l.push(new m(j,g,j,e));for(k=b[j]-1;k>=b[h];k-=1)l.push(new m(d[k+
1],e,d[k],e));a.push(new primitives.common.perimeter.Item(i,l))}var i=null,j,k,l,m,p;return{process:function(){i=null;j=b.getOrgTree();k=c.getTreeLevels();l=d.getTreeLevelsPositions();m=d.getItemsPositions();p=a.getOptions();return!0},getBackgroundManager:function(){null==i&&(i=e());return i}}};primitives.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(c){return a.getConfig(c)||null!=b&&b.getConfig(c)}}};
primitives.orgdiagram.ConnectionsGraphTask=function(a,b,c){function d(){var a,b,d,e,m,p,t,q=primitives.common.graph(),n,r;g.loopLevels(this,function(s){g.loopLevelItems(this,s,function(s){d=f.node(s);e=null!=h.hasItem(s)?100:1;if(d.connectorPlacement&8)p=[g.getPrevItem(s)];else if(d.connectorPlacement&2)p=[g.getNextItem(s)];else if(d.connectorPlacement&1){n=f.parent(s);p=1<n.partners.length?n.partners.slice(0):[n.id];var u=c.getOrgPartners(n.id);0<u.length&&(p=p.concat(u))}else p=[];a=0;for(b=p.length;a<
b;a+=1)t=p[a],m=null!=h.hasItem(t)?100:1,r=new primitives.famdiagram.EdgeItem(s,e,t,m),r.highlightItemId=s,1!=b&&(r.partnerid=t),q.addEdge(s,t,r)})});return q}var e=null,f,g,h;return{process:function(){e=null;f=a.getVisualTree();g=b.getTreeLevels();h=b.getActiveTreeLevels();return!0},getGraph:function(){null==e&&(e=d());return e}}};primitives.orgdiagram.DummyExtraPartnersTask=function(){var a={};return{process:function(){return!1},getOrgPartners:function(b){return a[b]||[]}}};
...
primitives.orgdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n;function r(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(M.orientationType){case 2:case 3:a.invert()}if(!E.isEmpty())switch(K.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=s(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(K.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}E.loopLevelsReversed(this,
function(a){var b;for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=s(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=s(c,0);if(!v(b,f)&&(a=0,b=s(c,c.length-1),v(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=s(c,g),v(b,f)?e=g:a=g;e!==g&&(b=s(c,e))}}return b}function s(a,b){var c,d;t=[];E.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;t.push(a)});for(c=0;c<=b;c+=1)d=a[c],t[d.level].currentvisibility=
d.currentvisibility;A();D();w();c=K.lineLevelShift;var f,e,g,h=d=0;f=8*J.linesWidth;switch(J.arrowsDirection){case 1:d=f;h=0;break;case 2:d=0,h=f}f=0;for(e=t.length;f<e;f+=1)g=t[f],c+=g.setShift(c,B(g.actualVisibility),h,d);return new primitives.common.Rect(0,0,Math.round(y()),Math.round(u()))}function v(a,b){var c=!1;switch(K.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function u(){var a=t[t.length-
1];return a.shift+a.nextLevelShift}function y(){var a=0,b,c;b=0;for(c=t.length;b<c;b+=1)a=Math.max(a,t[b].currentOffset);return a+=K.normalItemsInterval}function A(){var a=m.getCursorTreeItem();q={};E.loopLevels(this,function(b){var c=t[b];E.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=p.isItemSelected(b)?1:d.visibility,g=l.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==b,g,K,M);q[b]=f})})}function w(){var a,b,c,d,f,e,h,k,
j,i,l,m,p,u;E.loopLevels(this,function(n){var x=t[n];x.shift=0;x.depth=0;x.partnerConnectorOffset=0;x.actualVisibility=4;h=[];l=i=null;E.loopLevelItems(this,n,function(a,b){var c=q[a];x.depth=Math.max(x.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:l=!l?c.actualSize.height:Math.min(l,c.actualSize.height);break;default:i=!i?c.actualSize.height:Math.min(i,c.actualSize.height)}x.actualVisibility=Math.min(x.actualVisibility,c.actualVisibility);c=g.getOrgPartners(b.id);(0<
b.partners.length||0<c.length)&&h.push(b)});null==i&&(i=x.depth);null!=l&&l>i&&(i=l);switch(K.verticalAlignment){case 0:x.horizontalConnectorsDepth=i/2;break;case 1:x.horizontalConnectorsDepth=x.depth/2;break;case 2:x.horizontalConnectorsDepth=x.depth-i/2}if(0<h.length){u=primitives.common.pile();a=0;for(b=h.length;a<b;a+=1){f=h[a];n=g.getOrgPartners(f.id);k=f.partners.slice(0);0===k.length&&k.push(f.id);k=k.concat(n);p=m=null;c=0;for(d=k.length;c<d;c+=1)j=q[k[c]],e=j.offset+j.actualSize.width/2,
m=null!=m?Math.min(m,e):e,p=null!=p?Math.max(p,e):e;u.add(m,p,f)}x.partnerConnectorOffset=u.resolve(this,function(a,b,c,d){q[c.id].partnerConnectorOffset=d+1})}})}function B(a){var b=0;switch(a){case 1:b=K.normalLevelShift;break;case 2:b=K.dotLevelShift;break;case 3:case 4:b=K.lineLevelShift}return b}function D(){var a,b;a=0;for(b=t.length;a<b;a+=1)t[a].currentOffset=0;E.loopItems(this,function(a,b){x(a,b,0);return!0})}function x(a,b,c){var d=q[a],f=d.actualVisibility,e=t[c],f=h.getInterval(0===f?
e.currentvisibility:f)/2,g,k,j,i,l,m,p;l=8*J.linesWidth;d.leftPadding=f+(0<e.currentOffset?f*b.relationDegree*K.cousinsIntervalMultiplier:0);d.rightPadding=f;0!=J.arrowsDirection&&(b.connectorPlacement&8&&(d.leftPadding+=l),b.connectorPlacement&2&&(d.rightPadding+=l));d.offset=e.currentOffset+d.leftPadding;e.currentOffset=d.offset+d.actualSize.width+d.rightPadding;if(G.hasChildren(a))if(G.loopChildren(this,b.id,function(a,b){x(a,b,c+1)}),a=F(b),0<a)z(b,a);else if(0>a&&(a=-a,C(b,a),g=null,k={},i=null,
d=G.parent(b.id),null!==d&&(G.loopChildrenReversed(this,d.id,function(a,c){if(c===b)g=[];else if(null!==g){var d=null,f=[],e,h,l,m;e=I[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);h=0;for(l=e.length;h<l;h+=1)m=q[e[h]],f[h]=m.offset+m.actualSize.width+m.rightPadding;e=[];var p;h=Q[b.id];void 0===h&&(h=[]);h=h.slice();h.splice(0,0,b.id);l=0;for(m=h.length;l<m;l+=1)p=q[h[l]],e[l]=p.offset-p.leftPadding;h=Math.min(f.length,e.length);for(l=0;l<h&&!(m=e[l]-f[l],d=null!==d?Math.min(d,m):m,0>=
m);l+=1);j=Math.floor(d);k[c.id]=j;if(0<j)g.splice(0,0,c);else return i=c,!0}}),0<g.length))){e=null;if(null!==i){l=[i];l=l.concat(g);l.push(b);e=[[i]];d=1;for(f=l.length;d<f;d+=1)m=l[d-1],p=l[d],2==m.gravity||1==p.gravity?e[e.length-1].push(p):e.push([p])}else e=[g.slice(0)],e[e.length-1].push(b);if(0<e.length){g=e[e.length-1];for(d=g.length-2;0<=d;d-=1)p=g[d],j=k[p.id],a=Math.min(j,a),C(p,a),z(p,a)}l=a/(e.length-1);for(f=e.length-2;0<f;f-=1){m=e[f];for(d=m.length-1;0<=d;d-=1)p=m[d],j=k[p.id],a=
Math.min(f*l,Math.min(j,a)),C(p,a),z(p,a)}}}function F(a){var b=q[a.id],b=b.offset+b.actualSize.width/2,c=null,d,f,e;if(null===a.visualAggregatorId)switch(d=null,G.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),f=q[d.id],e=null,G.loopChildrenReversed(this,a.id,function(a,b){e=b;if(e.connectorPlacement&1)return!0}),a=q[e.id],P.horizontalAlignment){case 1:c=f.offset+f.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(f.offset+a.offset+a.actualSize.width)/
2}else a=q[a.visualAggregatorId],c=a.offset+a.actualSize.width/2;return b-c}function C(a,b){var c=q[a.id];c.offset+=b;var d=t[E.getLevelIndex(a.id)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width)}function z(a,b){var c,d,f;G.hasChildren(a.id)&&(G.loopChildren(this,a.id,function(a,f){c=f;d=q[a];d.offset+=b;z(c,b)}),f=t[E.getLevelIndex(c.id)],f.currentOffset=Math.max(f.currentOffset,d.offset+d.actualSize.width))}function L(){E.loopLevels(this,function(a){var b=t[a];E.loopLevelItems(this,
a,function(a){q[a].setPosition(b,K,M)})})}q={};t=[];n=null;var E,G,Q,I,M,J,P,K,R;return{process:function(){var g;K=d.getOptions();M=c.getOptions();J=e.getOptions();P=f.getOptions();E=j.getTreeLevels();G=i.getVisualTree();Q=k.getLeftMargins();I=k.getRightMargins();t=[];q={};g=a.getOptimalPanelSize();R=b.getOptions();g.scale(1/R.scale);g=new primitives.common.Rect(0,0,g.width,g.height);n=r(g);L();return!0},getTreeLevelsPositions:function(){return t},getItemsPositions:function(){return q},getItemPosition:function(a){return q[a]},
getContentSize:function(){return n}}};
primitives.orgdiagram.OrgTreeTask=function(a){var b,c;function d(a){var d,h,i,j,k,l=0,m,p=primitives.common.tree();j=0;for(k=a.length;j<k;j+=1)i=a[j],null!=i.id&&(d=new primitives.orgdiagram.OrgItem(i),m=parseInt(i.id,10),l=Math.max(isNaN(m)?0:m,l),p.add(i.parent,d.id,d));l+=1;a=new primitives.orgdiagram.ItemConfig;a.id=l;a.title="internal root";a.isVisible=!1;a.isActive=!1;h=new primitives.orgdiagram.OrgItem(a);h.hideParentConnection=!0;h.hideChildrenConnection=!0;p.add(null,h.id,h);p.loopLevels(this,
function(a,b,c){if(0<c)return p.BREAK;h.id!=a&&(p.adopt(h.id,a),b.itemType=0)});e(p);b=p;c=l;return!0}function e(a){a.loopLevels(this,function(b,c){var d=!0;if(c.isVisible)return a.SKIP;a.loopChildren(this,b,function(a,b){if(0!=b.itemType)return d=!1,!0});if(d)c.hideChildrenConnection=!0,a.loopChildren(this,b,function(a,b){b.hideParentConnection=!0});else return a.SKIP})}c=b=null;return{process:function(){d(a.getItems());return!0},getOrgTree:function(){return b},getMaximumId:function(){return c}}};
...
primitives.orgdiagram.TracePathAnnotationsTask=function(a,b,c,d,e){function f(a,b,c,d,f){var e,h,i,r,s,v,u,y,A,w,B,D={};e=0;for(h=a.length;e<h;e+=1)if(i=a[e],null!=i.items&&0<i.items.length&&(w=i.items.slice(0),s=d.node(w[0]),null!=s&&(1==w.length&&f.loopParents(this,s.id,function(a){c.node(a).isActive&&w.push(a);return f.SKIP}),1<w.length))){i=1;for(r=w.length;i<r;i+=1)if(u=d.node(w[i]),null!=u){A=b.getShortestPath(s.id,u.id,function(a,b,c){return a.getNear(c)});s=1;for(v=A.length;s<v;s+=1)B=b.edge([A[s-
1]],[A[s]]),y=g(D,B.highlightItemId),y.highlightPath=1,B.hasOwnProperty("partnerid")&&(y=g(D,B.partnerid),y.partnerHighlightPath=1);s=u}}return D}function g(a,b){var c=a[b];null==c&&(c=new primitives.orgdiagram.TreeItemHighlightPath,a[b]=c);return c}var h={},i=new primitives.orgdiagram.TreeItemHighlightPath;return{process:function(){var g=e.getNavigationFamily(),k=c.getOrgTree(),i=d.getVisualTree(),m=b.getGraph(),p=a.getAnnotations();h=f(p,m,k,i,g);return!0},getHighlightPath:function(a){return h[a]||
...
primitives.orgdiagram.VisualTreeMarginsTask=function(a){function b(a,b,c){a.loop(this,function(a){b[a]=[];c[a]=[]});a.loopPostOrder(this,function(a,d,e){var d=b[e],k=c[e],l=b[a],m=c[a],p;if(null!=e){d[0]||(d[0]=a);e=0;for(p=l.length;e<p;e+=1)d[e+1]||(d[e+1]=l[e]);k[0]=a;e=0;for(p=m.length;e<p;e+=1)k[e+1]=m[e]}})}var c={},d={};return{process:function(){c={};d={};b(a.getVisualTree(),c,d);return!0},getLeftMargins:function(){return c},getRightMargins:function(){return d}}};
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,r,B,D,x,F,C,z,L,E,G,Q={},I,M={},J,P,K,R={},W;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,C,F;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=t({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));K=P=0;if(null!=
(x=c.indexOf(f)))P=x,K=c.countSiblings(f)-x-1;C=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=t({parentId:f,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:q(i,e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 8:case 2:g=c.parent(f);if(i.connectorPlacement&2)B=l(c,n.navigationFamily,i),c.add(g.id,
e.id,e,B+1),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)D=m(c,n.navigationFamily,i),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:B=l(c,n.navigationFamily,i);c.add(g.id,e.id,e,B+1);e.connectorPlacement=6;e.gravity=2;break;default:D=m(c,n.navigationFamily,i),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0);break;case 2:q(i,e)}break;case 4:q(i,
e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 1:null===i.visualAggregatorId&&p(c,i,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&q(i,e);break;case 0:C.push(e);q(i,e);break;case 7:case 6:g=c.parent(f);if(i.connectorPlacement&2)c.add(g.id,e.id,e,P),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
...
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&W.push(c)}}),1<W.length&&(R[f]=W)}Q[f]=[];M[f]=[];var z=i,r=h.childrenPlacementType,w=Q[f],L=M[f],E,G,I,J,$,Z,ca,Y,fa=4==z.visibility&&0===z.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:G=3;break;case 2:G=2}0===r&&(r=k(a,z)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);E=z;null!==z.visualAggregatorId&&(E=c.node(z.visualAggregatorId));3==r&&3>C.length&&
(r=2);switch(r){case 2:r=0;for(J=C.length;r<J;r+=1)z=C[r],w=a.node(z.id),c.add(E.id,z.id,z),z.connectorPlacement=(w.hideParentConnection?0:1)|(w.hideChildrenConnection?0:4),0===r&&(z.relationDegree=1);break;case 3:J=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(C.length)));$=Math.ceil(C.length/J);Z=Math.ceil(J/2);for(ca=0;ca<Z;ca+=1){G=E;for(Y=0;Y<$;Y+=1){z=j(C,2*ca,Y,J);r=j(C,2*ca+1,Y,J);void 0===w[Y]&&(w[Y]=[],L[Y]=[]);null!==z&&(0===ca&&(z.relationDegree=1),c.add(G.id,z.id,z),z.connectorPlacement=
(fa?0:2)|4,z.gravity=2,L[Y].push(z));if(null!==z||null!==r)I=t({visibility:4,connectorPlacement:fa?0:5}),c.add(G.id,I.id,I),w[Y].push(I);null!==r&&(c.add(G.id,r.id,r),r.connectorPlacement=(fa?0:8)|4,r.gravity=1,L[Y].push(r));G=I}}2<J&&(E.visualAggregatorId=null);break;case 1:r=0;for(J=C.length;r<J;r+=1){z=C[r];I=t({visibility:4,connectorPlacement:fa?0:5});E.visualAggregatorId=I.id;switch(G){case 2:c.add(E.id,z.id,z);c.add(E.id,I.id,I);z.connectorPlacement=(fa?0:2)|4;z.gravity=2;break;case 3:c.add(E.id,
I.id,I),c.add(E.id,z.id,z),z.connectorPlacement=(fa?0:8)|4,z.gravity=1}w[r]=[I];L[r]=[z];E=I}break;default:throw"Children placement is undefined!";}});a.loopPostOrder(this,function(a){var b=c.node(a),d,e,g;if(null!=b){d=M[a];e=Q[a];L=h(c,b);if(0<L&&(b.visualDepth=L+1,null!==b.visualAggregatorId)){r=c.node(b.visualAggregatorId);g=c.hasChildren(r.id);for(x=0;x<L-1;x+=1)r=p(c,r,!g)}g=0;var k=c.parent(b.id),j,l,m;if(null!==k){j=c.indexOf(b.id);for(l=1;null!=(m=c.getChild(k.id,j+l));)if(m.connectorPlacement&
8)g=Math.max(g,i(c,m)),l+=1;else break;for(l=1;null!=(m=c.getChild(k.id,j-l));)if(m.connectorPlacement&2)g=Math.max(g,i(c,m)),l+=1;else break}L=g;if(1<L){b.visualDepth+=L-1;g=c.hasChildren(a);r=b;for(x=0;x<L-1;x+=1)r=p(c,r,!g)}E=[];x=0;for(F=d.length;x<F;x+=1){J=d[x];C=E[x]=0;for(z=J.length;C<z;C+=1)E[x]=Math.max(E[x],i(c,J[C]))}x=0;for(F=E.length;x<F;x+=1)if(G=E[x],1<G){C=0;for(z=e[x].length;C<z;C+=1)if(I=e[x][C],c.hasChildren(I.id))for(L=G;1<L;)I=p(c,I,!1),L-=1}null!=R[a]&&f(c,b,R[a])}})}function f(a,
b,c){var d,e,f,h,i=0,k=[],j,m;e=0;for(f=c.length;e<f;e+=1)d=c[e],i=Math.max(i,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];j=g(a,d);h=1;for(m=d;null!=m.visualAggregatorId;)m=a.node(m.visualAggregatorId),m.connectorPlacement=5,h+=1;for(;h<i;)j=p(a,j,!1),h+=1;k.push(g(a,j).id)}m=g(a,b);if(a.hasChildren(m.id)){j=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(j.id);f=l(a,n.navigationFamily,j);h=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;j=t({visibility:4,connectorPlacement:j.connectorPlacement&
10,gravity:h});a.add(e.id,j.id,j,f+1);for(h=1;h<i;)j=p(a,j,!1),j.connectorPlacement=0,h+=1}e=0;for(f=c.length;e<f;e+=1)d=c[e],n.navigationFamily.loopChildren(this,b.id,function(a,c){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;default:b.id!=d.id&&q(d,c)}return n.navigationFamily.SKIP});j=g(a,j);a.moveChildren(m.id,j.id)}j.partners=k}function g(a,b){for(var c=b;null!=c.visualAggregatorId;)c=a.node(c.visualAggregatorId);return c}function h(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,
...
c,d){if(0<d)return b.BREAK;e[a]=!0});else return d=g,!0});return d}function p(a,b,c){c=t({visibility:4,visualAggregatorId:b.visualAggregatorId,connectorPlacement:4==b.visibility&&0===b.connectorPlacement||c?0:5});a.insert(b.id,c.id,c);b.visualAggregatorId=c.id;return c}function t(a,b){var c=new primitives.orgdiagram.TreeItem,d;for(d in a)a.hasOwnProperty(d)&&(c[d]=a[d]);null!=b?(c.id=b.id,c.visibility=b.isVisible?0:4):(r+=1,c.id=r);return c}function q(a,c,d){var e=[];d||4==a.visibility||!b.getTemplateParams(a.id).isActive?
n.navigationFamily.loopParents(this,a.id,function(a,c){if(4!=c.visibility&&b.getTemplateParams(a).isActive)return e.push(a),n.navigationFamily.SKIP}):e.push(a.id);null!=n.navigationFamily.node(c.id)?n.navigationFamily.adopt(e,c.id):n.navigationFamily.add(e,c.id,c)}var n={visualTree:null,navigationFamily:null},r;return{process:function(){var b=a.getOrgTree(),d=c.getOptions();n.visualTree=primitives.common.tree();n.navigationFamily=primitives.common.family();r=a.getMaximumId();b.hasNodes()&&e(b,d,n.visualTree);
return!0},getVisualTree:function(){return n.visualTree},getNavigationFamily:function(){return n.navigationFamily}}};primitives.common.AnnotationLabelTemplate=function(){var a,b=jQuery("<div></div>");b.addClass("bp-item bp-corner-all bp-connector-label");a=b.wrap("<div>").parent().html();var c=primitives.common.hashCode(a);return{template:function(){return a},getHashCode:function(){return c},render:function(a,b){b.element.html(b.context.label)}}};
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,v);break;case 2:a=v;n.layout.forceCenterOnCursor=!1;n.tasks.process("HighlightItemOptionTask",null,a);n.graphics.end();break;default:null!=n.mouse&&n.mouse.destroy();j(n.layout);n.layout.element.find("."+n.name).remove();var a=n.layout,b=n.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),r=new primitives.common.Rect(e),B=a.element.offset(),D;D=jQuery('<div tabindex="0"></div>');
...
left:"0px"});B.addClass("placeholder");B.addClass(b);B.css(r.getCSS());r=jQuery("<div></div>");r.css({position:"absolute",overflow:"visible"});r.addClass("calloutplaceholder");r.addClass(b);r.css({top:"0px",left:"0px",width:"0px",height:"0px"});D.append(e);e.append(B);B.append(r);a.element.append(D);a.scrollPanel=D;a.mousePanel=e;a.placeholder=B;a.calloutPlaceholder=r;n.options.enablePanning&&(n.mouse=new primitives.common.Mouse,n.mouse.init(n.layout.element,{name:n.name,onMouseDrag:k,onMouseStop:l,
onMouseCapture:m}));a=n.layout;a.mousePanel.mousemove(function(a){var b=n.layout.mousePanel.offset(),c=a.pageX-b.left,b=a.pageY-b.top,d=n.tasks.getTask("CreateTransformTask"),e=n.tasks.getTask("HighlightItemOptionTask");if(!n.mouse||!n.mouse.isStarted())s=!1,e.hasHighlightEnabled()&&(c=d.getTreeItemForMousePosition(c,b),null!==c&&p(a,c.id))}).click(function(a){if(!n.mouse||!n.mouse.isStarted()){var b=n.layout.mousePanel.offset(),c=a.pageX-b.left,e=a.pageY-b.top,f=n.tasks.getTask("CreateTransformTask"),
b=n.tasks.getTask("CursorItemOptionTask"),c=f.getTreeItemForMousePosition(c,e),g;null!==c&&(c=c.id,s||(e=jQuery(a.target),e.hasClass(n.name+"button")||0<e.parent("."+n.name+"button").length?(g=e.hasClass(n.name+"button")?e:e.parent("."+n.name+"button"),g=g.data("buttonname"),g=d(n,null,c,g),q("onButtonClick",a,g)):"selectiontext"!==e.attr("name")&&("checkbox"===e.attr("name")?(b=(n.options.selectedItems||[]).slice(0),g=d(n,null,c,g),q("onSelectionChanging",a,g),e=primitives.common.indexOf(b,c),0<=
e?b.splice(e,1):b.push(c),n.options.selectedItems=b,q("onSelectionChanged",a,g)):(g=d(n,null,c,void 0),q("onMouseClick",a,g),!g.cancel&&b.hasCursorEnabled()&&(t(a,c),n.layout.scrollPanel.focus())))))}s=!1}).dblclick(function(a){var b;b=n.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&!s&&(b=d(n,null,b,void 0),q("onMouseDblClick",a,b));s=!1});a.scrollPanel.keydown(function(a){var b=n.tasks.getTask("HighlightItemTask"),c=n.tasks.getTask("HighlightItemOptionTask"),d=n.tasks.getTask("CursorItemTask"),
e=n.tasks.getTask("CursorItemOptionTask"),f=n.tasks.getTask("AlignDiagramTask"),g=n.tasks.getTask("CreateTransformTask").getTransform(),h=null,i,k=null,j=n.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(h=b.getHighlightTreeItem(),null===h&&(h=d.getCursorTreeItem())):c.hasHighlightEnabled()?h=b.getHighlightTreeItem():e.hasCursorEnabled()&&(h=d.getCursorTreeItem());if(null!=h){switch(a.which){case 13:e.hasCursorEnabled()&&(t(a,h),a.preventDefault(),j.scrollPanel.focus());break;case 40:k=1;break;
case 38:k=0;break;case 37:k=2;break;case 39:k=3}if(null!=k){for(b=!1;!b;){b=!0;k=g.getOrientation(k);switch(k){case 0:i=f.getNextLevelTreeItem(h,!1);break;case 1:i=f.getNextLevelTreeItem(h,!0);break;case 2:i=f.getNextTreeItem(h,!0);break;case 3:i=f.getNextTreeItem(h,!1)}null!=i&&(a.preventDefault(),c.hasHighlightEnabled()?p(a,i):e.hasCursorEnabled()&&t(a,i))}j.scrollPanel.focus()}}});n.tasks=c(g,h,i);n.graphics=primitives.common.createGraphics(n.options.graphicsType,n.layout.element);n.graphics.debug=
v;n.options.actualGraphicsType=n.graphics.graphicsType;f(!0,v)}}function f(a,b){var c;n.layout.forceCenterOnCursor=a;n.tasks.process("OptionsTask",null,b);n.graphics.end();a&&(c=n.tasks.getTask("CenterOnCursorTask"),c=c.getPlaceholderOffset(),n.layout.scrollPanel.scrollLeft(c.x),n.layout.scrollPanel.scrollTop(c.y))}function g(){return n.options}function h(){return n.graphics}function i(){return n.layout}function j(a){null!=a.mousePanel&&(a.mousePanel.unbind("mousemove"),a.mousePanel.unbind("click"),
a.mousePanel.unbind("dblclick"));null!=a.scrollPanel&&a.scrollPanel.unbind("keydown")}function k(a){var b=new primitives.common.Point(a.pageX,a.pageY),a=-b.x+r.x,b=-b.y+r.y,c=n.layout.scrollPanel;c.css("visibility","hidden");c.scrollLeft(a).scrollTop(b);c.css("visibility","inherit");return!1}function l(){s=!0}function m(a){var b=n.layout.scrollPanel;r=new primitives.common.Point(b.scrollLeft()+a.pageX,b.scrollTop()+a.pageY);return!0}function p(a,b){var c=!0,e;null!==b?b!==n.options.highlightItem&&
(e=d(n,n.options.highlightItem,b,void 0),n.options.highlightItem=b,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e))):null!==n.options.highlightItem&&(e=d(n,n.options.highlightItem,null,void 0),n.options.highlightItem=null,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e)));return c}function t(a,b){var c;b!==n.options.cursorItem&&(c=d(n,n.options.cursorItem,b,void 0),n.options.cursorItem=b,q("onCursorChanging",a,c),c.cancel||(f(!0,v),
q("onCursorChanged",a,c)))}function q(a,b,c){a=n.options[a];null!=a&&a(b,c)}var n={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:a,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},r,s,v=!1;e();return{destroy:function(){j(n.layout);n.layout.element.find("."+n.name).remove();n.tasks=null;n.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(n.options[b]=a[b])},getOptions:g,setOption:function(a,
b){return n.options[a]=b},getOption:function(a){return n.options[a]},update:e,getProcessDiagramConfig:function(){return c(g,h,i).getProcessDiagramConfig()}}};
...
"background"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#000080");f.addTask("HighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConfig","defaultHighlightPathAnnotationConfig"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");f.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#000080");f.addTask("BackgroundConnectorAnnotationOptionTask",
...
"#00ffff");f.addTask("ConnectionsGraphTask",["VisualTreeTask","VisualTreeLevelsTask","ExtraPartnersTask"],primitives.orgdiagram.ConnectionsGraphTask,"#00ffff");f.addTask("TracePathAnnotationsTask",["HighlightPathAnnotationOptionTask","ConnectionsGraphTask","OrgTreeTask","VisualTreeTask","VisualTreeTask"],primitives.orgdiagram.TracePathAnnotationsTask,"#00ffff");f.addTask("HighlightItemTask",["HighlightItemOptionTask","OrgTreeTask"],primitives.orgdiagram.HighlightItemTask,"#00ffff");f.addTask("CursorItemTask",
["CursorItemOptionTask","OrgTreeTask"],primitives.orgdiagram.CursorItemTask,"#00ffff");f.addTask("CursorNeighboursTask",["CursorItemTask","VisualTreeTask"],primitives.orgdiagram.CursorNeighboursTask,"#00ffff");f.addTask("SelectedItemsTask",["SelectedItemsOptionTask"],primitives.orgdiagram.SelectedItemsTask,"#00ffff");f.addTask("SelectionPathItemsTask",["VisualTreeTask","CursorItemTask","SelectedItemsTask","CursorSelectionPathModeOptionTask"],primitives.orgdiagram.SelectionPathItemsTask,"#00ffff");
f.addTask("NormalVisibilityItemsByForegroundShapeAnnotationTask",["ForegroundShapeAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByBackgroundShapeAnnotationTask",["BackgroundShapeAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByBackgroundAnnotationTask",["BackgroundAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,
"#00ffff");f.addTask("NormalVisibilityItemsByHighlightPathAnnotationTask",["HighlightPathAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByForegroundConnectorAnnotationTask",["ForegroundConnectorAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask,"#00ffff");f.addTask("NormalVisibilityItemsByBackgroundConnectorAnnotationTask",["BackgroundConnectorAnnotationOptionTask"],primitives.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask,
"#00ffff");f.addTask("CombinedNormalVisibilityItemsTask","ItemsSizesOptionTask CursorItemTask CursorNeighboursTask SelectedItemsTask SelectionPathItemsTask NormalVisibilityItemsByForegroundShapeAnnotationTask NormalVisibilityItemsByBackgroundShapeAnnotationTask NormalVisibilityItemsByBackgroundAnnotationTask NormalVisibilityItemsByHighlightPathAnnotationTask NormalVisibilityItemsByForegroundConnectorAnnotationTask NormalVisibilityItemsByBackgroundConnectorAnnotationTask".split(" "),primitives.orgdiagram.CombinedNormalVisibilityItemsTask,
"#00ffff");f.addTask("ItemsPositionsTask","CurrentControlSizeTask ScaleOptionTask OrientationOptionTask ItemsSizesOptionTask ConnectorsOptionTask VisualTreeOptionTask ExtraPartnersTask IntervalsTask VisualTreeTask VisualTreeLevelsTask VisualTreeMarginsTask ItemTemplateParamsTask CursorItemTask CombinedNormalVisibilityItemsTask".split(" "),primitives.orgdiagram.ItemsPositionsTask,"#ff0000");f.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask PrintPreviewOptionTask CurrentControlSizeTask VisualTreeTask VisualTreeLevelsTask ItemsPositionsTask isFamilyChartMode".split(" "),
primitives.orgdiagram.AlignDiagramTask,"#ff0000");f.addTask("CreateTransformTask",["OrientationOptionTask","AlignDiagramTask"],primitives.orgdiagram.CreateTransformTask,"#00ffff");f.addTask("CenterOnCursorTask","layout CurrentControlSizeTask CurrentScrollPositionTask CursorItemTask AlignDiagramTask CreateTransformTask ScaleOptionTask".split(" "),primitives.orgdiagram.CenterOnCursorTask,"#00ffff");f.addTask("BackgroundAnnotationManagerTask",["ItemsSizesOptionTask","OrgTreeTask","VisualTreeLevelsTask",
...
primitives.orgdiagram.DrawConnectorsTask,"#008000");f.addTask("DrawItemLabelsTask","graphics CreateTransformTask ApplyLayoutChangesTask LabelsOptionTask VisualTreeLevelsTask AlignDiagramTask".split(" "),primitives.orgdiagram.DrawItemLabelsTask,"#008000");f.addTask("DrawPrintPreviewTask","graphics ApplyLayoutChangesTask PrintPreviewOptionTask AlignDiagramTask PrintPreviewTemplateTask ScaleOptionTask".split(" "),primitives.orgdiagram.DrawPrintPreviewTask,"#008000");return f},function(a,b,e,f){var g=
new primitives.orgdiagram.EventArgs,h=a.tasks.getTask("CombinedContextsTask"),i=a.tasks.getTask("AlignDiagramTask"),b=h.getConfig(b),j=h.getConfig(e);b&&null!=b.id&&(g.oldContext=b);j&&null!=j.id&&(g.context=j,null!==j.parent&&(g.parentItem=h.getConfig(j.parent)),h=a.layout.mousePanel.offset(),a=a.layout.element.offset(),e=i.getItemPosition(e),g.position=(new primitives.common.Rect(e.actualPosition)).translate(h.left,h.top).translate(-a.left,-a.top));null!=f&&(g.name=f);return g})};
...
l;){m=k.segments.item(l);d.hasOwnProperty(m.oppositeKey)&&(j=d[m.oppositeKey],g.hasOwnProperty(j.id)&&!g[j.id]&&(g[j.id]=!0,j.segments.iterateBack(function(a){a.key!=m.oppositeKey&&k.segments.insertAfter(l,a.key,a)},m.oppositeKey,null),j.segments.iterateBack(function(a){k.segments.insertAfter(l,a.key,a)},null,m.oppositeKey)));j=k.segments;for(var p=m,t=j.nextKey(p.key),q=void 0;null!=p&&p.oppositeKey==(q=t||j.startKey());)null!=t&&(t=j.nextKey(t)),j.remove(p.key),j.remove(q),p=j.item(null!=t?j.prevKey(t):
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,j,k,l,m,p,t,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];j=d.length;k=e.length;i=h=0;t=m=p=l=null;0<j&&(l=d[h],p=!b?l:b(l));0<k&&(m=e[i],t=!b?m:b(m));for(q=null;h<j||i<k;)if(h>=j){if(!c||q!=m)f.push(m),q=m;i+=1;i<k&&(m=e[i],t=!b?m:b(m))}else if(i>=k){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],p=!b?l:b(l))}else if(p<t){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],p=!b?l:b(l))}else{if(!c||q!=m)f.push(m),
q=m;i+=1;i<k&&(m=e[i],t=!b?m:b(m))}d=f}}return d};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0===d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
primitives.common.family=function(a){function b(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e))break}function c(a,b){var c=!1;null!=r[a]&&null!=r[a][b]&&(delete r[a][b],s[a]-=1,delete v[b][a],u[b]-=1,s[a]||(delete r[a],delete s[a]),v[b]||(delete v[b],delete u[b],null==q[null]&&(q[null]={},n[null]=0),q[null][b]=!0,n[null]+=1),c=!0);return c}function d(a,b){var c;if(null!=b)for(c in y)if(y.hasOwnProperty(c)&&b.call(a,c,y[c]))break}function e(a,c,d,e){for(var f,
g,h={},i=0,k=!0;k;){f={};k=!1;for(g in d)if(d.hasOwnProperty(g)&&!h[g])switch(h[g]=!0,e.call(a,g,y[g],i)){case A:f={};k=!1;break;case w:break;default:b(this,c,g,function(a){h[a]||(k=f[a]=!0)})}d=f;i+=1}}function f(a,b,c){null!=c&&null!=b&&(null!=y[b]&&null!=r[b])&&e(a,r,r[b],c)}function g(a,b,c){null!=c&&null!=b&&(null!=y[b]&&null!=v[b])&&e(a,v,v[b],c)}function h(a,c,d,e,f,g){var h,i,k,j;if(null!=g){c=[];i={};for(h in y)y.hasOwnProperty(h)&&(i[h]=d[h]||0,i[h]||c.push(h));for(j=0;0<c.length;){k=[];
d=0;for(f=c.length;d<f;d+=1){h=c[d];if(g.call(a,h,y[h],j)){k=[];break}j+=1;b(this,e,h,function(a){i[a]-=1;0===i[a]&&k.push(a)})}c=k}}}function i(a,b){h(a,v,u,r,s,b)}function j(a,b){h(a,r,s,v,u,b)}function k(a,b,c,d,e,f,g,h,i){var k=!1,j,l;if(null!=y[a]&&null!=g[a]){k=!0;if(i){i=0;for(j=b.length;i<j;i+=1)if(l=b[i],null==y[l]||null==g[a][l])k=!1}if(k&&(null!=d&&(y[c]=d),null!=y[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},h[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,h[a]+=1);i=0;for(j=b.length;i<
j;i+=1)l=b[i],c!=l&&(null!=g[a][l]&&(delete g[a][l],h[a]-=1),null!=e[l][a]&&(delete e[l][a],f[l]-=1),e[l][c]||(e[l][c]=!0,f[l]+=1),g[c][l]||(g[c][l]=!0,h[c]+=1))}}return k}function l(a,b,c,d){return k(a,b,c,d,v,u,r,s,!0)}function m(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function p(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function t(a){var c=primitives.common.graph(),d,e,f,g,h,i,k,j,l={};for(d in a)a.hasOwnProperty(d)&&
b(this,r,d,function(d){if(!l.hasOwnProperty(d)){l[d]=!0;e=[];b(this,v,d,function(a){e.push(a)});f=0;for(h=e.length;f<h-1;f+=1)if(i=e[f],a.hasOwnProperty(i))for(g=f+1;g<h;g+=1)if(k=e[g],a.hasOwnProperty(k)){j=Math.abs(a[i].children.length-a[k].children.length);var m=c.edge(i,k);null==m&&(m=new p(j),c.addEdge(i,k,m));m.items.push(d);m.weight+=1}}});return c}var q={},n={},r={},s={},v={},u={},y={},A=1,w=2;primitives.common.isObject(a)&&(q=primitives.common.cloneObject(a.roots,!1),n=primitives.common.cloneObject(a.rootsCount,
!0),r=primitives.common.cloneObject(a.children,!1),s=primitives.common.cloneObject(a.childrenCount,!0),v=primitives.common.cloneObject(a.parents,!1),u=primitives.common.cloneObject(a.parentsCount,!0),y=primitives.common.cloneObject(a.nodes,!0));return{add:function(a,c,d){var e,f,g={};if(!a||0===a.length)a=[null];if(null==y[c]&&null!=d){y[c]=d;d=0;for(e=a.length;d<e;d+=1)f=a[d],null==g[f]&&f!=c&&(g[f]=!0,null!=y[f]?(null==v[c]&&(v[c]={},u[c]=0),v[c][f]||(v[c][f]=!0,u[c]+=1),null==r[f]&&(r[f]={},s[f]=
0),r[f][c]||(r[f][c]=!0,s[f]+=1)):(null==q[f]&&(q[f]={},n[f]=0),q[f][c]||(q[f][c]=!0,n[f]+=1)));null!=q[c]&&(r[c]=q[c],s[c]=n[c],delete q[c],delete n[c],b(this,r,c,function(a){null==v[a]&&(v[a]={},u[a]=0);v[a][c]||(v[a][c]=!0,u[a]+=1)}))}},adopt:function(a,b){var c,d,e;if(null!=y[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==v[b]&&(v[b]={},u[b]=0),e!=b&&null!=y[e])v[b][e]||(v[b][e]=!0,u[b]+=1),null==r[e]&&(r[e]={},s[e]=0),r[e][b]||(r[e][b]=!0,s[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";
}else throw"Child should be in hierarchy!";},bundleChildren:l,bundleParents:function(a,b,c,d){return k(a,b,c,d,r,s,v,u,!0)},optimizeReferences:function(a){var c={},d={},e={},g,h,i,j,l,p;if(null!=a){for(g in y)y.hasOwnProperty(g)&&(h=new m,b(this,r,g,function(a){h.children.push(a);h.childrenHash[a]=!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),e[h.id]=h);for(;!primitives.common.isEmptyObject(e);){i={};j=t(e);for(g in e)e.hasOwnProperty(g)&&(l=e[g],l.processed||(p=j.getSpanningTree(g,function(a,
b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),p.loopLevels(this,function(b,g){e[b].processed=!0;p.loopChildren(this,b,function(h,l){var p=j.edge(b,h),n=null,q,t,z,C,G;e[h].processed=!0;if(1<p.weight){t=p.items.join(",");if(c.hasOwnProperty(t))n=c[t];else{q=a();y[q.id]=q;n=new m;n.id=q.id;n.key=t;t=0;for(z=p.items.length;t<z;t+=1)n.children.push(p.items[t]),n.childrenHash[p.items[t]]=!0;n.children.sort();c[n.key]=n;d[n.id]=n;i[n.id]=n;C=n.children.slice(0);f(this,
g.replacementItem||b,function(a){null!=d[a]&&!n.childrenHash[a]&&(G=!0,f(this,a,function(a){return!n.childrenHash[a]?(G=!1,A):w}),G&&C.push(a));return w});k(g.replacementItem||b,C,n.id,q,v,u,r,s,!1);if(1>=(s[b]||0))g.replacementItem=n.id}if(n.id!=h&&(C=n.children.slice(0),f(this,l.replacementItem||h,function(a){null!=d[a]&&!n.childrenHash[a]&&(G=!0,f(this,a,function(a){return!n.childrenHash[a]?(G=!1,A):w}),G&&C.push(a));return w}),k(l.replacementItem||h,C,n.id,null,v,u,r,s,!1),1>=(s[h]||0)))l.replacementItem=
n.id}})})));e=i}}},eliminateManyToMany:function(a){var c,d;for(c in r)r.hasOwnProperty(c)&&1<(s[c]||0)&&b(this,r,c,function(b){if(1<(u[b]||0))d=a(),l(c,[b],d.id,d)})},removeNode:function(a){null!=y[a]&&(b(this,r,a,function(b){delete v[b][a];u[b]-=1;u[b]||(delete v[b],delete u[b],null==q[null]&&(q[null]={},n[null]=0),q[null][b]||(q[null][b]=!0,n[null]+=1))}),b(this,v,a,function(b){delete r[b][a];s[b]-=1;s[b]||(delete r[b],delete s[b])}),null!=q[null]&&null!=q[null][a]&&(delete q[null][a],n[null]-=
1,n[null]||(delete q[null],delete n[null])),delete r[a],delete s[a],delete v[a],delete u[a],delete y[a])},removeRelation:function(a,b){var d=!1;null!=y[a]&&null!=y[b]&&(d=c(a,b)||c(b,a));return d},node:function(a){return y[a]},loop:d,loopLevels:function(a,c,d){function e(){this.items={};this.minimumLevel=null}function f(a,b,c){var d=p[b];d||(d=new e,p[b]=d);d.addItemToLevel(a,c);w=null==w?c:Math.min(w,c);m[a]=c;k[a]=!0}var g=[],h={},k={},l=[],m={},p={},n,q,t,s,u,w=null;t=c?i:j;var A,V,N,T,O,S,H,X;
e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){t(this,function(a,b,c){g.push(a);h[a]=c});t=0;for(A=g.length;t<A;t+=1)if(n=g[t],null==k[n]){l.push(n);for(f(n,t,0);0<l.length;){O=T=N=null;S=!c;H=[];n=0;for(s=l.length;n<s;n+=1)u=l[n],V=m[u],X=!1,c?(b(this,v,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==N||!S||N<b||N==b&&O>V-1))N=b,T=a,O=V-1,S=!0}),b(this,r,u,function(a){var b;
if(!k[a]&&(X=!0,b=h[a],null==N||!S&&(N>b||N==b&&O<V+1)))N=b,T=a,O=V+1,S=!1})):(b(this,r,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==N||S||N<b||N==b&&O<V+1))N=b,T=a,O=V+1,S=!1}),b(this,v,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==N||S&&(N>b||N==b&&O>V-1)))N=b,T=a,O=V-1,S=!0})),X&&H.push(u);null!=T&&(H.push(T),f(T,t,O));l=H}}l=!0;for(c=w;l;){n={};l=!1;for(q in p)if(p.hasOwnProperty(q)&&(t=p[q],s=t.items[t.minimumLevel-w+c],null!=s)){n[q]=t;l=!0;t=0;for(A=s.length;t<A;t+=1)if(u=s[t],d.call(a,
u,y[u],c-w))return l=!1,!0}p=n;c+=1}}},loopTopo:i,loopTopoReversed:j,loopChildren:f,loopParents:g,findLargestRoot:function(){var a=null,b,c={},d={},e;b=null;j(this,function(f,h){c.hasOwnProperty(f)||(c[f]={},d[f]=0);c[f][f]=!0;d[f]+=1;e=!0;g(this,h.id,function(a){var b,g;e=!1;c.hasOwnProperty(a)||(c[a]={},d[a]=0);if(!d[a]&&1==u[f])c[a]=c[f],d[a]=d[f];else for(g in b=c[f],b)b.hasOwnProperty(g)&&(c[a][g]=!0,d[a]+=1);return w});if(e&&(!b||d[f]>b))b=d[f],a=f});return a},loopRoots:function(a,b){var c=
null,d,e=0,f={},h={},i,k={},l={},m,p,n,q,t,r,s;j(this,function(a,b){f.hasOwnProperty(a)||(f[a]={},h[a]=0);f[a][a]=!0;h[a]+=1;i=!0;g(this,b.id,function(b){var c,d;i=!1;f.hasOwnProperty(b)||(f[b]={},h[b]=0);if(!h[b]&&1==u[a])f[b]=f[a],h[b]=h[a];else for(d in c=f[a],c)c.hasOwnProperty(d)&&!f[b][d]&&(f[b][d]=!0,h[b]+=1);return w});i&&(k[a]=!0,e+=1)});q={};for(n in k)if(k.hasOwnProperty(n))for(p in d=f[n],d)d.hasOwnProperty(p)&&(q[p]||(q[p]=[]),q[p].push(n.toString()));for(;0<e;){d=null;for(m in k)if(k.hasOwnProperty(m)&&
(!d||h[m]<d))d=h[m],c=m;if(null!=c){null!=b&&b.call(a,c,y[c]);d=f[c];for(p in d)if(d.hasOwnProperty(p)&&!l[p]){n=q[p];r=0;for(s=n.length;r<s;r+=1)t=n[r],h[t]-=1;l[p]=!0}delete k[c];e-=1}}},hasNodes:function(){return!primitives.common.isEmptyObject(y)},hasCommonChild:function(a){var c=!1,d,e,f,g,h,i,k;d={};g=f=0;for(h=a.length;g<h;g+=1)i=a[g],null!=y[i]&&!d[i]&&(d[i]=!0,f+=1);e={};for(i in d)d.hasOwnProperty(i)&&b(this,r,i,function(a){e[a]=e[a]?e[a]+1:1});for(k in e)if(e.hasOwnProperty(k)&&null!=v[k]&&
...
0},countParents:function(a){return u[a]||0},firstParent:function(a){var b=null,a=v[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},firstChild:function(a){var b=null,a=r[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},validate:function(a){function c(a){var b=0,d;if(null!=a)for(d in a)a.hasOwnProperty(d)&&(b+=1);return b}var e,f;d(this,function(c){b(this,r,c,function(b){if(!v.hasOwnProperty(b)||!v[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+
c),!1});b(this,v,c,function(b){if(!r.hasOwnProperty(b)||!r[b].hasOwnProperty(c))return null!=a&&(a.message="Parent #"+b+" does not reference child #"+c),!1})});for(e in v)if(v.hasOwnProperty(e)){if((u[e]||0)!=c(v[e]))return null!=a&&(a.message="Parents count for item #"+e+" missmatch."),!1;if(v.hasOwnProperty(e)&&!y.hasOwnProperty(e))return null!=a&&(a.message="Orphant parents for item #"+e),!1}for(f in r)if(r.hasOwnProperty(f)){if((s[f]||0)!=c(r[f]))return null!=a&&(a.message="Children count for item "+
f+" missmatch."),!1;if(r.hasOwnProperty(f)&&!y.hasOwnProperty(f))return null!=a&&(a.message="Orphant children of item "+f),!1}for(f in q)if(q.hasOwnProperty(f)){if((n[f]||0)!=c(q[f]))return null!=a&&(a.message="Root children count for item @"+f+" missmatch."),!1;b(this,q,f,function(b){if(!y.hasOwnProperty(b))return null!=a&&(a.message="Child #"+b+"of root #"+f+" does not exists."),!1})}return!0},clone:function(){return primitives.common.family({roots:q,rootsCount:n,children:r,childrenCount:s,parents:v,
parentsCount:u,nodes:y})},BREAK:A,SKIP:w}};
primitives.common.graph=function(){var a={};return{addEdge:function(b,c,d){if((null==a[b]||null==a[b][c])&&null!=d)null==a[b]&&(a[b]={}),a[b][c]=d,null==a[c]&&(a[c]={}),a[c][b]=d},edge:function(b,c){var d=null;null!=a[b]&&a[b][c]&&(d=a[b][c]);return d},getSpanningTree:function(b,c){var d=primitives.common.tree(),e={},f,g=[],h,i={},j,k,l,m,p,t,q;e[b]=!0;j=1;i[b]=null;for(d.add(null,b.toString(),{});0<j;){g=[];m=l=k=null;for(f in e)if(e.hasOwnProperty(f)){p=a[f];h=!1;for(t in p)if(p.hasOwnProperty(t)&&
!i.hasOwnProperty(t)&&(q=p[t],h=!0,!l||0<=c(q,l)))k=t,l=q,m=f;h||g.push(f)}if(null==k)break;else e[k]=!0,j+=1,i[k]=m,d.add(m,k,{});h=0;for(k=g.length;h<k;h+=1)delete e[g[h]],j-=1}return d},getGrowthSequence:function(b){var c=[],d,e={},f;d=[];var g,h={},i=0,j,k,l,m,p,t;if(null!=b){d=null;l=0;m=null;for(g in a)if(a.hasOwnProperty(g)){k=a[g];l=0;for(j in k)k.hasOwnProperty(j)&&(l+=b(k[j]));if(l>m||null==m)d=g,m=l}if(null!=d){c.push(d);e[d]=!0;i+=1;for(h[d]=null;0<i;){d=[];k=j=null;l={};for(f in e)if(e.hasOwnProperty(f)){m=
a[f];g=!1;for(p in m)if(m.hasOwnProperty(p)&&!h.hasOwnProperty(p)&&(t=b(m[p]),g=!0,null==l[p]&&(l[p]=0),l[p]+=t,!k||l[p]>k))j=p,k=l[p];g||d.push(f)}if(null==j)break;else e[j]=!0,i+=1,h[j]=!0,c.push(j);g=0;for(j=d.length;g<j;g+=1)delete e[d[g]],i-=1}}}return c},getShortestPath:function(b,c,d){var e={},f={},g={},h,i,j,k,l;e[b]=!0;h=1;for(f[b]=0;0<h;){i=b=null;for(j in e)e.hasOwnProperty(j)&&(null==i?(b=j,i=f[j]):i>f[j]&&(b=j,i=f[j]));k=a[b];for(j in k)k.hasOwnProperty(j)&&(l=i+(null!=d?d(k[j],b,j):
...
b.resolve(d.dependencies,d.factory)());c.push(d)});f&&console.log("-- process --");for(var h={},i=0,j=c.length;i<j;i+=1){var k=c[i],l=[];if(k.name==d||h.hasOwnProperty(k.name))(g=k.task.process(f))&&a.loopChildren(this,k.name,function(b){h[b]=!0;f&&l.push(b);return a.SKIP}),f&&console.log(i+". "+k.name+(g?" - forces: "+l.toString():""));if(k.name==e)break}},getProcessDiagramConfig:function(){var d=new primitives.famdiagram.Config;0===c.length&&a.loopTopo(this,function(a,d){d.task=b.register(a,b.resolve(d.dependencies,
d.factory)());c.push(d)});for(var e=0,f=c.length;e<f;e+=1){var g=c[e],h=new primitives.famdiagram.ItemConfig;h.id=g.name;h.title=primitives.common.splitCamelCaseName(g.name).join(" ");h.description=g.task.description||"";h.itemTitleColor=g.color;h.parents=[];a.loopParents(this,g.name,function(b){h.parents.push(b);return a.SKIP});d.items.push(h)}return d}}};primitives.pdf.graphics=function(a){this._context=this._doc=a;this._dummyPlaceholder=new primitives.common.Placeholder};
...
primitives.pdf.graphics.prototype.polylinesBuffer=function(a){a.loop(this,function(a){0<a.length()&&this.polyline(a)})};
...
"#000080");a.addTask("HighlightPathAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConfig","defaultHighlightPathAnnotationConfig"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");a.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#000080");a.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig",
"background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#000080");a.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#000080");a.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#000080");a.addTask("IntervalsTask",["ItemsSizesOptionTask"],primitives.orgdiagram.IntervalsTask,"#00ffff");a.addTask("LogicalFamilyTask",["ItemsOptionTask"],
primitives.famdiagram.LogicalFamilyTask,"#00ffff");a.addTask("LabelAnnotationOptionTask",["SplitAnnotationsOptionTask","LogicalFamilyTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationOptionTask,"#000080");a.addTask("LabelAnnotationTemplateOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],primitives.famdiagram.LabelAnnotationTemplateOptionTask,"#000080");a.addTask("LabelAnnotationPlacementOptionTask",["LabelAnnotationOptionTask","defaultLabelAnnotationConfig"],
...
["SpousesOptionTask","RemoveLoopsTask"],primitives.famdiagram.AddSpousesTask,"#ff0000");a.addTask("NormalizeLogicalFamilyTask",["NormalizeOptionTask","AddSpousesTask"],primitives.famdiagram.NormalizeLogicalFamilyTask,"#ff0000");a.addTask("OrgTreeTask",["NormalizeLogicalFamilyTask","defaultItemConfig"],primitives.famdiagram.OrgTreeTask,"#ff0000");a.addTask("ReadTemplatesTask",["TemplatesOptionTask"],primitives.pdf.orgdiagram.ReadTemplatesTask,"#00ffff");a.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask",
"CursorItemOptionTask","ReadTemplatesTask"],primitives.orgdiagram.ItemTemplateParamsTask,"#00ffff");a.addTask("LabelAnnotationTemplateParamsTask",["ItemsSizesOptionTask","LabelAnnotationTemplateOptionTask","ReadTemplatesTask"],primitives.famdiagram.LabelAnnotationTemplateParamsTask,"#00ffff");a.addTask("CombinedTemplateParamsTask",["ItemTemplateParamsTask","LabelAnnotationTemplateParamsTask"],primitives.famdiagram.CombinedTemplateParamsTask,"#00ffff");a.addTask("GroupTitleTemplateTask",["TemplatesOptionTask"],
...
"#00ffff");a.addTask("VisualTreeTask",["OrgTreeTask","CombinedTemplateParamsTask","VisualTreeOptionTask","isFamilyChartMode"],primitives.orgdiagram.VisualTreeTask,"#ff0000");a.addTask("VisualTreeLevelsTask",["VisualTreeTask","CombinedTemplateParamsTask"],primitives.orgdiagram.VisualTreeLevelsTask,"#ff0000");a.addTask("VisualTreeMarginsTask",["VisualTreeTask"],primitives.orgdiagram.VisualTreeMarginsTask,"#ff0000");a.addTask("ConnectionsGraphTask",["VisualTreeTask","VisualTreeLevelsTask","OrgTreeTask"],
primitives.orgdiagram.ConnectionsGraphTask,"#00ffff");a.addTask("TracePathAnnotationsTask",["HighlightPathAnnotationOptionTask","ConnectionsGraphTask","OrgTreeTask","VisualTreeTask","AddLabelAnnotationsTask"],primitives.orgdiagram.TracePathAnnotationsTask,"#00ffff");a.addTask("HighlightItemTask",["HighlightItemOptionTask","OrgTreeTask"],primitives.orgdiagram.HighlightItemTask,"#00ffff");a.addTask("CursorItemTask",["CursorItemOptionTask","OrgTreeTask"],primitives.orgdiagram.CursorItemTask,"#00ffff");
a.addTask("SelectedItemsTask",["SelectedItemsOptionTask"],primitives.orgdiagram.SelectedItemsTask,"#00ffff");a.addTask("CombinedNormalVisibilityItemsTask",["OptionsTask"],primitives.pdf.orgdiagram.DummyCombinedNormalVisibilityItemsTask,"#00ffff");a.addTask("CurrentControlSizeTask",["OptionsTask"],primitives.pdf.orgdiagram.DummyCurrentControlSizeTask,"#00ffff");a.addTask("ItemsPositionsTask","CurrentControlSizeTask ScaleOptionTask OrientationOptionTask ItemsSizesOptionTask ConnectorsOptionTask VisualTreeOptionTask OrgTreeTask IntervalsTask VisualTreeTask VisualTreeLevelsTask VisualTreeMarginsTask CombinedTemplateParamsTask CursorItemTask CombinedNormalVisibilityItemsTask".split(" "),
primitives.orgdiagram.ItemsPositionsTask,"#ff0000");a.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask PrintPreviewOptionTask CurrentControlSizeTask VisualTreeTask VisualTreeLevelsTask ItemsPositionsTask isFamilyChartMode".split(" "),primitives.orgdiagram.AlignDiagramTask,"#ff0000");a.addTask("CreateTransformTask",["OrientationOptionTask","AlignDiagramTask"],primitives.orgdiagram.CreateTransformTask,"#00ffff");a.addTask("BackgroundAnnotationManagerTask",
["ItemsSizesOptionTask","OrgTreeTask","VisualTreeLevelsTask","AlignDiagramTask"],primitives.orgdiagram.BackgroundAnnotationManagerTask,"#00ffff");a.addTask("PaletteManagerTask",["ConnectorsOptionTask","LinePaletteOptionTask"],primitives.orgdiagram.PaletteManagerTask,"#00ffff");a.addTask("DrawBackgroundAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask BackgroundAnnotationOptionTask AddLabelAnnotationsTask AlignDiagramTask BackgroundAnnotationManagerTask".split(" "),primitives.orgdiagram.DrawBackgroundAnnotationTask,
...
primitives.orgdiagram.DrawConnectorAnnotationTask,"#008000");a.addTask("DrawTreeItemsTask","graphics CreateTransformTask ApplyLayoutChangesTask ItemsSizesOptionTask CombinedContextsTask VisualTreeTask AlignDiagramTask CombinedTemplateParamsTask CursorItemTask SelectedItemsTask GroupTitleTemplateTask CheckBoxTemplateTask ButtonsTemplateTask DrawBackgroundConnectorAnnotationTask".split(" "),primitives.orgdiagram.DrawTreeItemsTask,"#008000");a.addTask("DrawConnectorsTask","graphics CreateTransformTask ApplyLayoutChangesTask ConnectorsOptionTask VisualTreeTask VisualTreeLevelsTask AlignDiagramTask TracePathAnnotationsTask OrgTreeTask showElbowDots PaletteManagerTask DrawTreeItemsTask".split(" "),
primitives.orgdiagram.DrawConnectorsTask,"#008000");a.addTask("DrawCursorTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask CombinedTemplateParamsTask CursorItemTask SelectedItemsTask DrawConnectorsTask".split(" "),primitives.orgdiagram.DrawCursorTask,"#008000");a.addTask("DrawHighlightTask","graphics CreateTransformTask ApplyLayoutChangesTask CombinedContextsTask AlignDiagramTask CombinedTemplateParamsTask HighlightItemTask CursorItemTask SelectedItemsTask DrawCursorTask".split(" "),
...
primitives.orgdiagram.DrawConnectorAnnotationTask,"#008000");a.addTask("DrawPrintPreviewTask","graphics ApplyLayoutChangesTask PrintPreviewOptionTask AlignDiagramTask PrintPreviewTemplateTask ScaleOptionTask DrawForegroundConnectorAnnotationTask".split(" "),primitives.orgdiagram.DrawPrintPreviewTask,"#008000");return a}function e(){f.options.hasButtons=2;f.options.pageFitMode=5;f.options.autoSizeMaximum=new primitives.common.Size(1E5,1E5)}var f={name:"famdiagram",doc:null,options:a,tasks:null,graphics:null};
return{draw:function(a,h,i){f.doc=a;f.tasks=d(b,c);f.graphics=new primitives.pdf.graphics(f.doc);f.graphics.debug=!1;e();f.doc.save();f.doc.translate(h,i);f.tasks.process("OptionsTask",null,!1);f.doc.restore();a=f.tasks.getTask("AlignDiagramTask");return new primitives.common.Size(a.getContentSize())},getSize:function(){f.tasks=d(b,c);e();f.tasks.process("OptionsTask","AlignDiagramTask",!1);var a=f.tasks.getTask("AlignDiagramTask");return new primitives.common.Size(a.getContentSize())}}};
...
"#000080");a.addTask("SplitAnnotationsOptionTask",["OptionsTask"],primitives.orgdiagram.SplitAnnotationsOptionTask,"#00ffff");a.addTask("ForegroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","foreground"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#000080");a.addTask("BackgroundShapeAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultShapeAnnotationConfig","background"],primitives.orgdiagram.ShapeAnnotationOptionTask,"#000080");a.addTask("HighlightPathAnnotationOptionTask",
["SplitAnnotationsOptionTask","defaultConfig","defaultHighlightPathAnnotationConfig"],primitives.orgdiagram.HighlightPathAnnotationOptionTask,"#000080");a.addTask("ForegroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","foreground"],primitives.orgdiagram.ConnectorAnnotationOptionTask,"#000080");a.addTask("BackgroundConnectorAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultConnectorAnnotationConfig","background"],primitives.orgdiagram.ConnectorAnnotationOptionTask,
"#000080");a.addTask("BackgroundAnnotationOptionTask",["SplitAnnotationsOptionTask","defaultBackgroundAnnotationConfig"],primitives.orgdiagram.BackgroundAnnotationOptionTask,"#000080");a.addTask("ScaleOptionTask",["OptionsTask","defaultConfig"],primitives.orgdiagram.ScaleOptionTask,"#000080");a.addTask("CombinedContextsTask",["ItemsOptionTask"],primitives.orgdiagram.CombinedContextsTask,"#00ffff");a.addTask("IntervalsTask",["ItemsSizesOptionTask"],primitives.orgdiagram.IntervalsTask,"#00ffff");a.addTask("OrgTreeTask",
["ItemsOptionTask"],primitives.orgdiagram.OrgTreeTask,"#ff0000");a.addTask("ReadTemplatesTask",["TemplatesOptionTask"],primitives.pdf.orgdiagram.ReadTemplatesTask,"#00ffff");a.addTask("ItemTemplateParamsTask",["ItemsSizesOptionTask","CursorItemOptionTask","ReadTemplatesTask"],primitives.orgdiagram.ItemTemplateParamsTask,"#00ffff");a.addTask("GroupTitleTemplateTask",["TemplatesOptionTask"],primitives.pdf.orgdiagram.GroupTitleTemplateTask,"#00ffff");a.addTask("CheckBoxTemplateTask",["ItemsSizesOptionTask"],
primitives.pdf.orgdiagram.CheckBoxTemplateTask,"#00ffff");a.addTask("ButtonsTemplateTask",["ItemsSizesOptionTask"],primitives.pdf.orgdiagram.ButtonsTemplateTask,"#00ffff");a.addTask("AnnotationLabelTemplateTask",["ItemsOptionTask"],primitives.pdf.orgdiagram.AnnotationLabelTemplateTask,"#00ffff");a.addTask("PrintPreviewTemplateTask",["ItemsOptionTask"],primitives.pdf.orgdiagram.PrintPreviewTemplateTask,"#00ffff");a.addTask("VisualTreeTask",["OrgTreeTask","ItemTemplateParamsTask","VisualTreeOptionTask",
"isFamilyChartMode"],primitives.orgdiagram.VisualTreeTask,"#ff0000");a.addTask("VisualTreeLevelsTask",["VisualTreeTask","ItemTemplateParamsTask"],primitives.orgdiagram.VisualTreeLevelsTask,"#ff0000");a.addTask("VisualTreeMarginsTask",["VisualTreeTask"],primitives.orgdiagram.VisualTreeMarginsTask,"#ff0000");a.addTask("ExtraPartnersTask",["VisualTreeTask"],primitives.orgdiagram.DummyExtraPartnersTask,"#00ffff");a.addTask("ConnectionsGraphTask",["VisualTreeTask","VisualTreeLevelsTask","ExtraPartnersTask"],
primitives.orgdiagram.ConnectionsGraphTask,"#00ffff");a.addTask("TracePathAnnotationsTask",["HighlightPathAnnotationOptionTask","ConnectionsGraphTask","OrgTreeTask","VisualTreeTask","VisualTreeTask"],primitives.orgdiagram.TracePathAnnotationsTask,"#00ffff");a.addTask("HighlightItemTask",["HighlightItemOptionTask","OrgTreeTask"],primitives.orgdiagram.HighlightItemTask,"#00ffff");a.addTask("CursorItemTask",["CursorItemOptionTask","OrgTreeTask"],primitives.orgdiagram.CursorItemTask,"#00ffff");a.addTask("SelectedItemsTask",
["SelectedItemsOptionTask"],primitives.orgdiagram.SelectedItemsTask,"#00ffff");a.addTask("CombinedNormalVisibilityItemsTask",["OptionsTask"],primitives.pdf.orgdiagram.DummyCombinedNormalVisibilityItemsTask,"#00ffff");a.addTask("CurrentControlSizeTask",["OptionsTask"],primitives.pdf.orgdiagram.DummyCurrentControlSizeTask,"#00ffff");a.addTask("ItemsPositionsTask","CurrentControlSizeTask ScaleOptionTask OrientationOptionTask ItemsSizesOptionTask ConnectorsOptionTask VisualTreeOptionTask ExtraPartnersTask IntervalsTask VisualTreeTask VisualTreeLevelsTask VisualTreeMarginsTask ItemTemplateParamsTask CursorItemTask CombinedNormalVisibilityItemsTask".split(" "),
primitives.orgdiagram.ItemsPositionsTask,"#ff0000");a.addTask("AlignDiagramTask","OrientationOptionTask ItemsSizesOptionTask VisualTreeOptionTask ScaleOptionTask PrintPreviewOptionTask CurrentControlSizeTask VisualTreeTask VisualTreeLevelsTask ItemsPositionsTask isFamilyChartMode".split(" "),primitives.orgdiagram.AlignDiagramTask,"#ff0000");a.addTask("CreateTransformTask",["OrientationOptionTask","AlignDiagramTask"],primitives.orgdiagram.CreateTransformTask,"#00ffff");a.addTask("BackgroundAnnotationManagerTask",
...
"#008000");a.addTask("DrawBackgroundShapeAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask BackgroundShapeAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask background DrawBackgroundAnnotationTask".split(" "),primitives.orgdiagram.DrawShapeAnnotationTask,"#008000");a.addTask("DrawBackgroundConnectorAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask BackgroundConnectorAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask background DrawBackgroundShapeAnnotationTask".split(" "),
primitives.orgdiagram.DrawConnectorAnnotationTask,"#008000");a.addTask("DrawTreeItemsTask","graphics CreateTransformTask ApplyLayoutChangesTask ItemsSizesOptionTask CombinedContextsTask VisualTreeTask AlignDiagramTask ItemTemplateParamsTask CursorItemTask SelectedItemsTask GroupTitleTemplateTask CheckBoxTemplateTask ButtonsTemplateTask DrawBackgroundConnectorAnnotationTask".split(" "),primitives.orgdiagram.DrawTreeItemsTask,"#008000");a.addTask("DrawConnectorsTask","graphics CreateTransformTask ApplyLayoutChangesTask ConnectorsOptionTask VisualTreeTask VisualTreeLevelsTask AlignDiagramTask TracePathAnnotationsTask ExtraPartnersTask showElbowDots PaletteManagerTask DrawTreeItemsTask".split(" "),
primitives.orgdiagram.DrawConnectorsTask,"#008000");a.addTask("DrawForegroundShapeAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundShapeAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawConnectorsTask".split(" "),primitives.orgdiagram.DrawShapeAnnotationTask,"#008000");a.addTask("DrawForegroundConnectorAnnotationTask","graphics CreateTransformTask ApplyLayoutChangesTask OrientationOptionTask ForegroundConnectorAnnotationOptionTask AlignDiagramTask AnnotationLabelTemplateTask foreground DrawForegroundShapeAnnotationTask".split(" "),
