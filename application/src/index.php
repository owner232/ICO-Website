...
<!-- breadcrumb -->
                <div class="breadcrumb_content">
                    <div class="breadcrumb_text"><h3>Initial Coin Offering (ICO)</h3>
                    </div>
                </div>
                <!-- /breadcrumb -->
                ...
                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12 top_links">
                <input type="text" value="https://hextracoin.co/register?referrer=richiehubbard">
                <button class="submit">Copy</button>
                <div class="pdf"><a href="">Whitepaper(PDF)</a></div>
                </div>

                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12 timer">
                <ul class="time">
                <li>DAYS</li>
                <li>HRS</li>
                <li>MINS</li>
                ...
                <li>48 </li>
                     ...
                     <!-- top tiles -->
                    <div class="row top_tiles">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12 top_bar">
                            <div class="tile-stats tile-white bg-blue-sky">
                                <div class="icon"><i class="fa fa-shopping-cart"></i></div>
                                <div class="count"> <h5 class="heading">B<p>BTC</p></h5></div>
                                <h3>0.00000000</h3>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12 top_bar">
                            <div class="tile-stats tile-white bg-purple">
                                ...
                                <div class="count"> <h5 class="heading">Total Available Coin:</h5></div>
                                <h3>7,500,000 HXT</h3>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12 top_bar">
                            <div class="tile-stats tile-white bg-blue">
                                ...
                                <div class="count"><h5 class="heading">Sold Coin</h5></div>
                                <h3>1,500,000 HXT</h3>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12 top_bar">
                            <div class="tile-stats tile-white bg-purple">
                                ...
                                <div class="count"> <h5 class="heading">Opening in 00 hrs 00 mins 49 sec.</h5></div>
                                <h3>7,500,000 HXT</h3>
